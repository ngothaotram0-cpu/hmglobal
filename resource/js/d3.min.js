(function (t, n) {
  ...
  function au(t, n) {
    function e() {
      return (
        (i = Math.min(a.length, c.length) > 2 ? ou : iu), (o = u = null), r
      );
    }
    function r(n) {
  ...
  function yu() {
    function n() {
      return (
        (o = vu(i)), (u = du(i)), r()[0] < 0 && ((o = _u(o)), (u = _u(u))), e
      );
    }
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            L_.setTime(+n), q_.setTime(+r), t(L_), t(q_), Math.floor(e(L_, q_))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  var kp = function (t) {
    ...
    Sp = function (t, n) {
      return (
        (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, vp(n) - vp(t)) + 1
      );
    },
    Ep = function () {
      return new Ve();
  ...
  var Dd,
    ...
    Wd = function (t) {
      ...
      return (
        ...
        (n.invert = function (n) {
          return (
            (n = t.invert(n[0] * pd, n[1] * pd)), (n[0] *= hd), (n[1] *= hd), n
          );
        }),
        n
      );
