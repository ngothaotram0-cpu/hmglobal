    ...
    function create() {
        ...
        if (_.world) {
            ...
            if (this.hoverCanvas && __.options.showSelectedCountry) {
            	//console.log(_.selected.features);
...
var centerCanvas = (function () {
    ...
    function transition(p, id) {
        var __ = this._;

    	if(id==410){
    		var r = d3.interpolate(__.proj.rotate(), [-p[0], -20, 0]);
    	}else{
    		var r = d3.interpolate(__.proj.rotate(), [-p[0], -p[1], 0]);
    	}
        //var r = d3.interpolate(__.proj.rotate(), [-p[0], -p[1], 0]);
...
var globeThreejs = (function () {
    var imgUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '/resource/images/globe/map_gray.gif';
    var elvUrl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '/resource/images/globe/earth_elevation.jpg';
    var wtrUrl = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '/resource/images/globe/earth_water.png';
    ...
    function create() {
        ...
        if (!_.sphereObject) {
            ...
            var geometry = new THREE.SphereGeometry(SCALE, 90, 90);
...
var sphereThreejs = (function () {
  ...
  function create() {
    ...
    if (!_.sphereObject) {
      var SCALE = this._.proj.scale();
      var geometry = new THREE.SphereGeometry(SCALE, 120, 120);
...
var world3dThreejs = (function () {
    var worldUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '/resource/json/world.geometry.json';
    var imgUrl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '/resource/images/globe/gold.jpg';
...
var world3dThreejs2 = (function () {
    var worldUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '/resource/json/countries.geo.json';
    var landUrl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '/resource/images/globe/gold.jpg';
    var inner = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.9;
...
var selectCountryMix = (function () {
    var worldUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '/resource/json/world-110m.json';
