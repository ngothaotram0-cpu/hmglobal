(_xamzrequire = (function s(o, a, u) {
...
})(
  {
    38: [
      function (e, t, r) {
        (function (i) {
          function s(e, t) {
            if ("string" == typeof e) {
              if (0 <= ["legacy", "regional"].indexOf(e.toLowerCase()))
          ...
          t.exports = function (e, t) {
            ...
            if (
              ...
              return r;
            if (!o.util.isNode()) return r;
            if (
              Object.prototype.hasOwnProperty.call(i.env, t.env) &&
              (r = s(i.env[t.env], {
            ...
            var n = {};
            try {
              n = o.util.getProfilesFromSharedConfig(o.util.iniLoader)[
                i.env.AWS_PROFILE || o.util.defaultProfile
              ];
            } catch (e) {}
            return (
              n &&
                Object.prototype.hasOwnProperty.call(n, t.sharedConfig) &&
                (r = s(n[t.sharedConfig], {
                  code: "InvalidConfiguration",
                  message:
                    "invalid " +
                    t.sharedConfig +
          ...
          i = (function () {
            ...
            return (
              ...
              (s.prototype.put = function (e, t) {
                var r = "string" != typeof e ? s.getKeyString(e) : e,
                  n = this.populateValue(t);
                this.cache.put(r, n);
              }),
              (s.prototype.get = function (e) {
                var t = "string" != typeof e ? s.getKeyString(e) : e,
                  r = Date.now(),
                  n = this.cache.get(t);
                if (n)
                  for (var i = 0; i < n.length; i++) {
                    if (n[i].Expire < r) return void this.cache.remove(t);
                  }
                return n;
              }),
              (s.getKeyString = function (e) {
                for (
                  var t = [], r = Object.keys(e).sort(), n = 0;
                  n < r.length;
                  n++
                ) {
                  var i = r[n];
              ...
              (s.prototype.populateValue = function (e) {
                var t = Date.now();
          ...
          n = (function () {
            ...
            return (
              ...
              (e.prototype.prependToList = function (e) {
                this.headerNode
                  ? ((this.headerNode.prev = e).next = this.headerNode)
                  : (this.tailNode = e),
                  (this.headerNode = e),
                  this.size++;
              }),
              ...
              (e.prototype.put = function (e, t) {
                ...
                var n = new i(e, t);
                (this.nodeMap[e] = n), this.prependToList(n);
              }),
              (e.prototype.empty = function () {
                for (
                  var e = Object.keys(this.nodeMap), t = 0;
                  t < e.length;
                  t++
                ) {
                  var r = e[t],
          ...
          switch (r.type) {
            case "structure":
              return (
                ...
                (d = t),
                (m = r),
                void v.arrayEach(m.memberNames, function (e) {
                  var t = m.members[e];
                  if ("body" === t.location) {
                    var r = d[e],
                      n = t.name;
                    if (null != r)
                      if (t.isXmlAttribute) f.addAttribute(n, r);
                      else if (t.flattened) y(f, r, t);
                      else {
                        var i = new b(n);
                        f.addChildNode(i), g(i, t), y(i, r, t);
                      }
                  }
                })
              );
            case "map":
              return (
                ...
                (c = t),
                (l = (p = r).key.name || "key"),
                (h = p.value.name || "value"),
                void v.each(c, function (e, t) {
                  var r = new b(p.flattened ? p.name : "entry");
                  u.addChildNode(r);
                  var n = new b(l),
                    i = new b(h);
                  r.addChildNode(n),
            ...
            case "list":
              return (
                ...
                (o = t),
                void ((a = r).flattened
                  ? v.arrayEach(o, function (e) {
                      var t = a.member.name || a.name,
                        r = new b(t);
                      s.addChildNode(r), y(r, e, a.member);
                    })
                  : v.arrayEach(o, function (e) {
            ...
            default:
              return (
                (n = t), (i = r), void e.addChildNode(new S(i.toWireFormat(n)))
              );
          }
          var n, i, s, o, a, u, c, p, l, h, f, d, m;
        }
        function g(e, t, r) {
          var n,
            i = "xmlns";
          t.xmlNamespaceUri
            ? ((n = t.xmlNamespaceUri),
              t.xmlNamespacePrefix && (i += ":" + t.xmlNamespacePrefix))
            : r && t.api.xmlNamespaceUri && (n = t.api.xmlNamespaceUri),
            n && e.addAttribute(i, n);
        }
        var v = e("../util"),
          b = e("./xml-node").XmlNode,
          S = e("./xml-text").XmlText;
        (n.prototype.toXML = function (e, t, r, n) {
          var i = new b(r);
          return (
            g(i, t, !0),
            y(i, e, t),
            0 < i.children.length || n ? i.toString() : ""
          );
        }),
          (t.exports = n);
      },
    ...
    115: [
      function (e, t, r) {
        var s = e("../core"),
          n = e("./v4_credentials"),
          i = s.util.inherit;
        (s.Signers.V4 = i(s.Signers.RequestSigner, {
          constructor: function (e, t, r) {
            s.Signers.RequestSigner.call(this, e),
              (this.serviceName = t),
              (r = r || {}),
              (this.signatureCache =
                "boolean" != typeof r.signatureCache || r.signatureCache),
              (this.operation = r.operation),
              (this.signatureVersion = r.signatureVersion);
          },
          algorithm: "AWS4-HMAC-SHA256",
          addAuthorization: function (e, t) {
            var r = s.util.date.iso8601(t).replace(/[:\-]|\.\d{3}/g, "");
            this.isPresigned()
          ...
          updateForPresigned: function (e, t) {
            ...
            e.sessionToken && (n["X-Amz-Security-Token"] = e.sessionToken),
              this.request.headers["Content-Type"] &&
                (n["Content-Type"] = this.request.headers["Content-Type"]),
              this.request.headers["Content-MD5"] &&
                (n["Content-MD5"] = this.request.headers["Content-MD5"]),
              this.request.headers["Cache-Control"] &&
                (n["Cache-Control"] = this.request.headers["Cache-Control"]),
              s.util.each.call(this, this.request.headers, function (e, t) {
                if ("presigned-expires" !== e && this.isSignableHeader(e)) {
                  var r = e.toLowerCase();
                  0 === r.indexOf("x-amz-meta-")
                    ? (n[r] = t)
                    : 0 === r.indexOf("x-amz-") && (n[e] = t);
                }
              });
            var i = 0 <= this.request.path.indexOf("?") ? "&" : "?";
            this.request.path += i + s.util.queryParamsToString(n);
          },
          ...
          signature: function (e, t) {
            ...
            return s.util.crypto.hmac(r, this.stringToSign(t), "hex");
          },
          ...
          canonicalHeaders: function () {
            ...
            var n = [];
            return (
              s.util.arrayEach.call(this, r, function (e) {
                var t = e[0].toLowerCase();
                if (this.isSignableHeader(t)) {
                  var r = e[1];
                  if (null == r || "function" != typeof r.toString)
                    throw s.util.error(
                      new Error("Header " + t + " contains invalid value"),
                      {
                        code: "InvalidHeader",
                      }
                    );
                  n.push(t + ":" + this.canonicalHeaderValues(r.toString()));
                }
              }),
              n.join("\n")
            );
          ...
          signedHeaders: function () {
            var t = [];
            return (
              s.util.each.call(this, this.request.headers, function (e) {
                (e = e.toLowerCase()), this.isSignableHeader(e) && t.push(e);
              }),
              t.sort().join(";")
            );
          },
          ...
          hexEncodedHash: function (e) {
            return s.util.crypto.sha256(e, "hex");
          },
    ...
    116: [
      function (e, t, r) {
        ...
        t.exports = {
          ...
          getSigningKey: function (e, t, r, n, i) {
            var s = [
              p.util.crypto.hmac(e.secretAccessKey, e.accessKeyId, "base64"),
              t,
              r,
              n,
            ].join("_");
            if ((i = !1 !== i) && s in l) return l[s];
            var o = p.util.crypto.hmac("AWS4" + e.secretAccessKey, t, "buffer"),
              a = p.util.crypto.hmac(o, r, "buffer"),
              u = p.util.crypto.hmac(a, n, "buffer"),
              c = p.util.crypto.hmac(u, "aws4_request", "buffer");
            return (
              i &&
                ((l[s] = c), h.push(s), 50 < h.length && delete l[h.shift()]),
              c
            );
          },
          emptyCache: function () {
      ...
      function (e, t, r) {
        ...
        (n.Signers.V3 = i(n.Signers.RequestSigner, {
          ...
          signedHeaders: function () {
            var t = [];
            return (
              n.util.arrayEach(this.headersToSign(), function (e) {
          ...
          canonicalHeaders: function () {
            ...
            return (
              n.util.arrayEach(this.headersToSign(), function (e) {
                r.push(e.toLowerCase().trim() + ":" + String(t[e]).trim());
              }),
              r.sort().join("\n") + "\n"
            );
          },
          headersToSign: function () {
            var t = [];
            return (
              n.util.each(this.request.headers, function (e) {
                ("Host" === e ||
                  "Content-Encoding" === e ||
                  e.match(/^X-Amz/i)) &&
                  t.push(e);
    ...
    111: [
      function (e, t, r) {
        var o = e("../core"),
          n = o.util.inherit;
        (o.Signers.S3 = n(o.Signers.RequestSigner, {
          subResources: {
            acl: 1,
            accelerate: 1,
            analytics: 1,
          ...
          addAuthorization: function (e, t) {
            this.request.headers["presigned-expires"] ||
              (this.request.headers["X-Amz-Date"] = o.util.date.rfc822(t)),
              e.sessionToken &&
                (this.request.headers["x-amz-security-token"] = e.sessionToken);
            var r = this.sign(e.secretAccessKey, this.stringToSign()),
              n = "AWS " + e.accessKeyId + ":" + r;
            this.request.headers.Authorization = n;
          },
          stringToSign: function () {
            var e = this.request,
              t = [];
          ...
          canonicalizedAmzHeaders: function () {
            var t = [];
            o.util.each(this.request.headers, function (e) {
              e.match(/^x-amz-/i) && t.push(e);
            }),
              t.sort(function (e, t) {
            ...
            var r = [];
            return (
              o.util.arrayEach.call(this, t, function (e) {
                r.push(e.toLowerCase() + ":" + String(this.request.headers[e]));
              }),
              r.join("\n")
            );
          },
          canonicalizedResource: function () {
            var e = this.request,
              ...
              i = "";
            if (
              (e.virtualHostedBucket && (i += "/" + e.virtualHostedBucket),
              (i += r),
              n)
            ) {
              var s = [];
              o.util.arrayEach.call(this, n.split("&"), function (e) {
                var t = e.split("=")[0],
                  r = e.split("=")[1];
          ...
          sign: function (e, t) {
            return o.util.crypto.hmac(e, t, "base64", "sha1");
          },
        })),
          (t.exports = o.Signers.S3);
      },
      {
        "../core": 39,
      },
      ...
      function (e, t, r) {
        function n(e) {
          ...
          if (
            ...
            var n = e.service
              ? e.service.getSkewCorrectedDate()
              : o.util.date.getDate();
            e.httpRequest.headers[a] = parseInt(
              o.util.date.unixTimestamp(n) + t,
              10
            ).toString();
          }
        }
          ...
          if ("AWS" === i[0])
            (i = i[1].split(":")),
              ...
              o.util.each(e.httpRequest.headers, function (e, t) {
                e === a && (e = "Expires"),
                  0 === e.indexOf("x-amz-meta-") &&
                    (delete n[e], (e = e.toLowerCase())),
                  (n[e] = t);
              }),
            ...
            i.shift();
            var s = i.join(" ").match(/Signature=(.*?)(?:,|\s|\r?\n|$)/)[1];
            (n["X-Amz-Signature"] = s), delete n.Expires;
          }
        ...
        (o.Signers.Presign = s({
          sign: function (e, t, r) {
            if (
              ...
              e.removeListener(
                "afterBuild",
                o.EventListeners.Core.SET_CONTENT_LENGTH
              ),
              e.removeListener(
                "afterBuild",
                o.EventListeners.Core.COMPUTE_SHA256
              ),
        ...
        (function (n) {
          ...
          (p.Service = a({
            constructor: function (e) {
              ...
              if (t) {
                var r = p.util.copy(e),
                  n = new t(e);
                return (
                  Object.defineProperty(n, "_originalConfig", {
                    get: function () {
                      return r;
                    },
                    enumerable: !1,
            ...
            initialize: function (e) {
              var t = p.config[this.serviceIdentifier];
              if (
                ((this.config = new p.Config(p.config)),
                t && this.config.update(t, !0),
                e && this.config.update(e, !0),
                this.validateService(),
                this.config.endpoint || i.configureEndpoint(this),
                (this.config.endpoint = this.endpointFromTemplate(
                  this.config.endpoint
                )),
                this.setEndpoint(this.config.endpoint),
                p.SequentialExecutor.call(this),
                p.Service.addDefaultMonitoringListeners(this),
                (this.config.clientSideMonitoring ||
                  p.Service._clientSideMonitoring) &&
                  this.publisher)
              ) {
            ...
            loadServiceClass: function (e) {
              ...
              if (p.util.isEmpty(this.api)) {
                if (t.apiConfig)
                  return p.Service.defineServiceApi(
                    this.constructor,
                    t.apiConfig
                  );
                if (this.constructor.services) {
                  (t = new p.Config(p.config)).update(e, !0);
            ...
            getLatestServiceClass: function (e) {
              return (
                ...
                null === this.constructor.services[e] &&
                  p.Service.defineServiceApi(this.constructor, e),
            ...
            getLatestServiceVersion: function (e) {
              ...
              if (
                (e
                  ? p.util.isType(e, Date) &&
                    (e = p.util.date.iso8601(e).split("T")[0])
                  : (e = "latest"),
            ...
            makeRequest: function (e, r, t) {
              if (
                ...
                n &&
                  ((r = p.util.copy(r)),
                  p.util.each(this.config.params, function (e, t) {
                    n.input.members[e] &&
                      ((void 0 !== r[e] && null !== r[e]) || (r[e] = t));
                  }));
              }
              var i = new p.Request(this, e, r);
              return (
                this.addAllRequestListeners(i),
                this.attachMonitoringEmitter(i),
                t && i.send(t),
                i
              );
            },
            ...
            waitFor: function (e, t, r) {
              return new p.ResourceWaiter(this, e).wait(t, r);
            },
            addAllRequestListeners: function (e) {
              for (
                var t = [
                    p.events,
                    p.EventListeners.Core,
                    this.serviceInterface(),
                    p.EventListeners.CorePost,
                  ],
                  r = 0;
                r < t.length;
                r++
              ...
              this.config.paramValidation ||
                e.removeListener(
                  "validate",
                  p.EventListeners.Core.VALIDATE_PARAMETERS
                ),
                this.config.logger && e.addListeners(p.EventListeners.Logger),
            ...
            apiCallEvent: function (e) {
              var t = e.service.api.operations[e.operation],
                r = {
                  ...
                  Version: 1,
                  Service:
                    e.service.api.serviceId || e.service.api.endpointPrefix,
              ...
              if (
                (n.httpResponse.statusCode &&
                  (r.FinalHttpStatusCode = n.httpResponse.statusCode),
                n.error)
              ) {
                var i = n.error;
                299 < n.httpResponse.statusCode
                  ? (i.code && (r.FinalAwsException = i.code),
                    i.message && (r.FinalAwsExceptionMessage = i.message))
                  : ((i.code || i.name) &&
                      (r.FinalSdkException = i.code || i.name),
            ...
            apiAttemptEvent: function (e) {
              ...
              return (
                n.httpResponse.statusCode &&
                  (r.HttpStatusCode = n.httpResponse.statusCode),
                !e._unAuthenticated &&
            ...
            attachMonitoringEmitter: function (n) {
              var t,
                r,
                i,
                s,
              ...
              n.on(
                "validate",
                function () {
                  (s = p.util.realClock.now()), (a = Date.now());
                },
                !0
              ),
                n.on(
                  "sign",
                  function () {
                    (r = p.util.realClock.now()),
                      (t = Date.now()),
                      (o = n.httpRequest.region),
                      u++;
                  },
                  !0
                ),
                n.on("validateResponse", function () {
                  i = Math.round(p.util.realClock.now() - r);
                }),
                n.addNamedListener("API_CALL_ATTEMPT", "success", function () {
                  var e = c.apiAttemptEvent(n);
                  (e.Timestamp = t),
                    (e.AttemptLatency = 0 <= i ? i : 0),
                    (e.Region = o),
                    c.emit("apiCallAttempt", [e]);
                }),
                n.addNamedListener(
                  "API_CALL_ATTEMPT_RETRY",
                  "retry",
                  function () {
                    var e = c.attemptFailEvent(n);
                    (e.Timestamp = t),
                      (i = i || Math.round(p.util.realClock.now() - r)),
                      (e.AttemptLatency = 0 <= i ? i : 0),
                      (e.Region = o),
                      c.emit("apiCallAttempt", [e]);
                  }
                ),
                n.addNamedListener("API_CALL", "complete", function () {
                  var e = c.apiCallEvent(n);
                  if (((e.AttemptCount = u), !(e.AttemptCount <= 0))) {
                    e.Timestamp = a;
                    var t = Math.round(p.util.realClock.now() - s);
                    e.Latency = 0 <= t ? t : 0;
                    var r = n.response;
                    "number" == typeof r.retryCount &&
                      "number" == typeof r.maxRetries &&
                      r.retryCount >= r.maxRetries &&
                      (e.MaxRetriesExceeded = 1),
                      c.emit("apiCall", [e]);
                  }
                });
            },
            ...
            getSignerClass: function (e) {
              ...
              return (
                e &&
                  (n = (r =
                    (e.service.api.operations || {})[e.operation] || null)
                    ? r.authtype
                    : ""),
                (t = this.config.signatureVersion
                  ? this.config.signatureVersion
                  : "v4" === n || "v4-unsigned-body" === n
                  ? "v4"
                  : this.api.signatureVersion),
                p.Signers.RequestSigner.getVersion(t)
              );
            },
            ...
            retryDelays: function (e, t) {
              return p.util.calculateRetryDelay(
                e,
            ...
            isClockSkewed: function (e) {
              if (e)
                return (
                  3e5 <= Math.abs(this.getSkewCorrectedDate().getTime() - e)
                );
            },
            ...
            endpointFromTemplate: function (e) {
              ...
              return (t = (t = t.replace(
                /\{service\}/g,
                this.api.endpointPrefix
              )).replace(/\{region\}/g, this.config.region)).replace(
                /\{scheme\}/g,
                this.config.sslEnabled ? "https" : "http"
              );
            },
            setEndpoint: function (e) {
              this.endpoint = new p.Endpoint(e, this.config);
            },
            paginationConfig: function (e, t) {
              ...
              if (t) {
                var n = new Error();
                throw p.util.error(n, "No pagination configuration for " + e);
              }
              return null;
            },
          })),
            p.util.update(p.Service, {
              defineMethods: function (e) {
                p.util.each(e.prototype.api.operations, function (r) {
                  e.prototype[r] ||
                    ("none" === e.prototype.api.operations[r].authtype
                      ? (e.prototype[r] = function (e, t) {
                          return this.makeUnauthenticatedRequest(r, e, t);
                        })
                      : (e.prototype[r] = function (e, t) {
              ...
              defineService: function (e, t, r) {
                (p.Service._serviceMap[e] = !0),
                  Array.isArray(t) || ((r = t), (t = []));
                var n = a(p.Service, r || {});
                if ("string" == typeof e) {
                  p.Service.addVersions(n, t);
                  var i = n.serviceIdentifier || e;
                  n.serviceIdentifier = i;
                } else (n.prototype.api = e), p.Service.defineMethods(n);
                if (
                  (p.SequentialExecutor.call(this.prototype),
                  !this.prototype.publisher && p.util.clientSideMonitoring)
                ) {
                  var s = p.util.clientSideMonitoring.Publisher,
                    o = (0, p.util.clientSideMonitoring.configProvider)();
                  (this.prototype.publisher = new s(o)),
                    o.enabled && (p.Service._clientSideMonitoring = !0);
                }
                return (
                  p.SequentialExecutor.call(n.prototype),
                  p.Service.addDefaultMonitoringListeners(n.prototype),
                  n
                );
              },
              ...
              defineServiceApi: function (t, e, r) {
                function n(e) {
                  e.isApi
                    ? (i.prototype.api = e)
                    : (i.prototype.api = new s(e, {
                ...
                if ("string" == typeof e) {
                  if (r) n(r);
                    ...
                    try {
                      n(p.apiLoader(t.serviceIdentifier, e));
                    } catch (r) {
                      throw p.util.error(r, {
                        message:
                  ...
                  Object.prototype.hasOwnProperty.call(t.services, e) ||
                    (t.apiVersions = t.apiVersions.concat(e).sort()),
                    (t.services[e] = i);
                } else n(e);
                return p.Service.defineMethods(i), i;
              },
              hasService: function (e) {
                return Object.prototype.hasOwnProperty.call(
                  p.Service._serviceMap,
                  e
                );
              },
              addDefaultMonitoringListeners: function (r) {
                r.addNamedListener(
            ...
            p.util.mixin(p.Service, p.SequentialExecutor),
            (t.exports = p.Service);
        }).call(this, e("_process"));
      },
      {
      ...
      function (e, t, r) {
        function c(r, e) {
          p.each(e, function (e, t) {
            "globalEndpoint" !== e &&
              ((void 0 !== r.config[e] && null !== r.config[e]) ||
                (r.config[e] = t));
          });
        }
        var p = e("./util"),
          l = e("./region_config_data.json");
        t.exports = {
          configureEndpoint: function (e) {
            for (
              ...
              var n = t[r];
              if (n && Object.prototype.hasOwnProperty.call(l.rules, n)) {
                var i = l.rules[n];
                return (
                  "string" == typeof i && (i = l.patterns[i]),
                  e.config.useDualstack &&
                    p.isDualstackAvailable(e) &&
                    ((i = p.copy(i)).endpoint =
                      "{service}.dualstack.{region}.amazonaws.com"),
                  (e.isGlobalEndpoint = !!i.globalEndpoint),
                  i.signatureVersion || (i.signatureVersion = "v4"),
                  void c(e, i)
                );
              }
            }
        ...
        a.Response = n({
          constructor: function (e) {
            (this.request = e),
              ...
              (this.httpResponse = new a.HttpResponse()),
              e &&
          ...
          nextPage: function (e) {
            var t,
              ...
              n = this.request.operation;
            try {
              t = r.paginationConfig(n, !0);
            } catch (e) {
              this.error = e;
            }
            if (!this.hasNextPage()) {
            ...
            var i = a.util.copy(this.request.params);
            if (this.nextPageTokens) {
              var s = t.inputToken;
              "string" == typeof s && (s = [s]);
              for (var o = 0; o < s.length; o++)
                i[s[o]] = this.nextPageTokens[o];
          ...
          cacheNextPageTokens: function () {
            ...
            if (
              ...
              e.moreResults && !i.search(this.data, e.moreResults))
            )
              return this.nextPageTokens;
            var t = e.outputToken;
            return (
              "string" == typeof t && (t = [t]),
              a.util.arrayEach.call(this, t, function (e) {
    ...
    85: [
      function (e, t, r) {
        function n(r) {
          var n = r.request._waiter,
            e = n.config.acceptors,
            i = !1,
            s = "retry";
          e.forEach(function (e) {
            if (!i) {
              var t = n.matchers[e.matcher];
              t && t(r, e.expected, e.argument) && ((i = !0), (s = e.state));
            }
          }),
            !i && r.error && (s = "failure"),
            "success" === s ? n.setSuccess(r) : n.setError(r, "retry" === s);
        }
        var i = e("./core"),
          s = i.util.inherit,
          o = e("jmespath");
        i.ResourceWaiter = s({
          ...
          matchers: {
            ...
            error: function (e, t) {
              return "string" == typeof t && e.error
                ? t === e.error.code
                : t === !!e.error;
            },
          },
          ...
          wait: function (e, t) {
            "function" == typeof e && ((t = e), (e = void 0)),
              e &&
                e.$waiter &&
                ("number" == typeof (e = i.util.copy(e)).$waiter.delay &&
                  (this.config.delay = e.$waiter.delay),
          ...
          (c.setupStates = function () {
                ...
                n.emit(n._asm.currentState, function (e) {
                  if (e)
                    if (
                      ...
                      if (!(a && n.domain instanceof a.Domain)) throw e;
                      (e.domainEmitter = n),
                        (e.domain = n.domain),
                        (e.domainThrown = !1),
                        n.domain.emit("error", e);
                    } else (n.response.error = e), r(e);
                  else r(n.response.error);
                  var t;
                });
            };
            ...
            (h.Request = e({
              constructor: function (e, t, r) {
                var n = e.endpoint,
                  i = e.config.region,
                  s = e.config.customUserAgent;
                e.isGlobalEndpoint && (i = "us-east-1"),
                  (this.domain = a && a.active),
                  (this.service = e),
                  (this.operation = t),
                  (this.params = r || {}),
                  (this.httpRequest = new h.HttpRequest(n, i)),
                  this.httpRequest.appendToUserAgent(s),
                  (this.startTime = e.getSkewCorrectedDate()),
                  (this.response = new h.Response(this)),
                  (this._asm = new o(c.states, "validate")),
                  (this._haltHandlersOnError = !1),
                  h.SequentialExecutor.call(this),
              ...
              eachPage: function (n) {
                (n = h.util.fn.makeAsync(n, 3)),
                  this.on("complete", function t(r) {
                    n.call(r, r.error, r.data, function (e) {
                      !1 !== e &&
                        (r.hasNextPage()
                          ? r.nextPage().on("complete", t).send()
                          : n.call(r, null, null, h.util.fn.noop));
                    });
                  }).send();
              },
              eachItem: function (s) {
                ...
                this.eachPage(function (e, t) {
                  if (e) return s(e, null);
                  if (null === t) return s(null, null);
                  var r = o.service.paginationConfig(o.operation).resultKey;
                  Array.isArray(r) && (r = r[0]);
                  var n = u.search(t, r),
                    i = !0;
                  return (
                    h.util.arrayEach(n, function (e) {
                      if (!1 === (i = s(null, e))) return h.util.abort;
                    }),
                    i
                  );
                });
              ...
              createReadStream: function () {
                var c = h.util.stream,
                  ...
                  l = null;
                return (
                  2 === h.HttpClient.streamsApiVersion
                    ? ((l = new c.PassThrough()),
                      t.nextTick(function () {
                        p.send();
                      }))
                    : (((l = new c.Stream()).readable = !0),
                      (l.sent = !1),
                      l.on("newListener", function (e) {
                        l.sent ||
                          "data" !== e ||
                          ((l.sent = !0),
                          t.nextTick(function () {
                  ...
                  this.on("httpHeaders", function (e, t, r) {
                    if (e < 300) {
                      p.removeListener(
                        "httpData",
                        h.EventListeners.Core.HTTP_DATA
                      ),
                        p.removeListener(
                          "httpError",
                          h.EventListeners.Core.HTTP_ERROR
                        ),
                        p.on("httpError", function (e) {
                          (r.error = e), (r.error.retryable = !1);
                        });
                      var n,
                        i = !1;
                      if (
                        ("HEAD" !== p.httpRequest.method &&
                          (n = parseInt(t["content-length"], 10)),
                      ...
                      var o = function () {
                        ...
                        a = r.httpResponse.createUnbufferedStream();
                      if (2 === h.HttpClient.streamsApiVersion)
                        if (i) {
                          var u = new c.PassThrough();
                          (u._write = function (e) {
                            return (
                              e && e.length && (s += e.length),
                              c.PassThrough.prototype._write.apply(
                                this,
                                arguments
                              )
                            );
                            ...
                            l.on("error", function (e) {
                              (i = !1), a.unpipe(u), u.emit("end"), u.end();
                            }),
                            a.pipe(u).pipe(l, {
                              end: !1,
                            });
              ...
              emitEvent: function (e, t, r) {
                "function" == typeof t && ((r = t), (t = null)),
                  ...
                  h.SequentialExecutor.prototype.emit.call(
                    this,
                    e,
                    t,
                    function (e) {
              ...
              presign: function (e, t) {
                return (
                  ...
                  new h.Signers.Presign().sign(this.toGet(), e, t)
                );
              },
              isPresigned: function () {
                return Object.prototype.hasOwnProperty.call(
              ...
              toUnauthenticated: function () {
                return (
                  ...
                  this.removeListener(
                    "validate",
                    h.EventListeners.Core.VALIDATE_CREDENTIALS
                  ),
                  this.removeListener("sign", h.EventListeners.Core.SIGN),
                  this
                );
              },
              toGet: function () {
            ...
            (h.Request.addPromisesToClass = function (t) {
                  ...
                  new t(function (t, r) {
                    e.on("complete", function (e) {
                      e.error
                        ? r(e.error)
                        : t(
                            Object.defineProperty(e.data || {}, "$response", {
                              value: e,
                            })
                          );
                    }),
            ...
            (h.Request.deletePromisesFromClass = function () {
              delete this.prototype.promise;
            }),
            h.util.addPromises(h.Request),
            h.util.mixin(h.Request, h.SequentialExecutor);
    ...
    117: [
      function (e, t, r) {
        ...
        (n.prototype.runTo = function (t, r, n, e) {
          "function" == typeof t && ((e = n), (n = r), (r = t), (t = null));
          var i = this,
            s = i.states[i.currentState];
          s.fn.call(n || i, e, function (e) {
            if (e) {
              if (!s.fail) return r ? r.call(n, e) : null;
              i.currentState = s.fail;
            } else {
              if (!s.accept) return r ? r.call(n) : null;
              i.currentState = s.accept;
            }
            if (i.currentState === t) return r ? r.call(n, e) : null;
            i.runTo(t, r, n, e);
          });
        }),
    ...
    71: [
      function (e, t, r) {
        var u = e("./core");
        u.ParamValidator = u.util.inherit({
          constructor: function (e) {
            (!0 !== e && void 0 !== e) ||
              (e = {
                min: !0,
          ...
          validateType: function (e, t, r, n) {
            ...
            for (var i = !1, s = 0; s < r.length; s++) {
              if ("string" == typeof r[s]) {
                ...
                n || i || (r = r.slice()), (r[s] = u.util.typeName(r[s]));
              }
              i = !0;
            }
            var o = n;
            o || (o = r.join(", ").replace(/,([^,]+)$/, ", or$1"));
            var a = o.match(/^[aeiou]/i) ? "n" : "";
            return (
              this.fail(
                "InvalidParameterType",
                "Expected " + t + " to be a" + a + " " + o
              ),
              !1
            );
          },
          validateNumber: function (e, t, r) {
            if (null != t) {
              ...
              this.validateType(t, r, ["number"]) &&
                this.validateRange(e, t, r, "numeric value");
            }
          },
          validatePayload: function (e, t) {
            if (
              ...
              if (u.util.isNode()) {
                var r = u.util.stream.Stream;
                if (u.util.Buffer.isBuffer(e) || e instanceof r) return;
              ...
              if (e)
                for (var i = 0; i < n.length; i++) {
                  if (u.util.isType(e, n[i])) return;
                  if (u.util.typeName(e.constructor) === n[i]) return;
                }
              this.fail(
                "InvalidParameterType",
                "Expected " +
    ...
    65: [
      function (e, t, r) {
        var i = e("./collection"),
          ...
          p = e("../util"),
          l = p.property,
          h = p.memoizedProperty;
        t.exports = function (t, r) {
          var n = this;
          (t = t || {}),
            ((r = r || {}).api = this),
            (t.metadata = t.metadata || {});
          var e = r.serviceIdentifier;
          delete r.serviceIdentifier,
            l(this, "isApi", !0, !1),
            l(this, "apiVersion", t.metadata.apiVersion),
            l(this, "endpointPrefix", t.metadata.endpointPrefix),
            l(this, "signingName", t.metadata.signingName),
            l(this, "globalEndpoint", t.metadata.globalEndpoint),
            l(this, "signatureVersion", t.metadata.signatureVersion),
            l(this, "jsonVersion", t.metadata.jsonVersion),
            l(this, "targetPrefix", t.metadata.targetPrefix),
            l(this, "protocol", t.metadata.protocol),
            l(this, "timestampFormat", t.metadata.timestampFormat),
            l(this, "xmlNamespaceUri", t.metadata.xmlNamespace),
            l(this, "abbreviation", t.metadata.serviceAbbreviation),
            l(this, "fullName", t.metadata.serviceFullName),
            l(this, "serviceId", t.metadata.serviceId),
            e && l(this, "xmlNoDefaultLists", c[e].xmlNoDefaultLists, !1),
            h(this, "className", function () {
              var e =
                t.metadata.serviceAbbreviation || t.metadata.serviceFullName;
              return e
                ? ("ElasticLoadBalancing" ===
                    (e = e.replace(/^Amazon|AWS\s*|\(.*|\s+|\W+/g, "")) &&
                    (e = "ELB"),
                  e)
                : null;
            }),
            l(
              ...
              new i(
                ...
                p.string.lowerFirst,
                function (e, t) {
                  !0 === t.endpointoperation &&
                    l(n, "endpointOperation", p.string.lowerFirst(e));
                }
              )
            ),
            l(
            ...
            l(
              this,
              "paginators",
              new i(t.paginators, r, function (e, t) {
                return new a(e, t, r);
              })
            ),
            l(
            ...
            r.documentation &&
              (l(this, "documentation", t.documentation),
              l(this, "documentationUrl", t.documentationUrl));
        };
      },
      {
      ...
      function (e, t, r) {
        ...
        t.exports = function (e, r, t) {
          (t = t || {}),
            ...
            s(this, "api", t.api, !1),
            r.operation &&
              s(this, "operation", i.string.lowerFirst(r.operation));
          var n = this;
          ["type", "description", "delay", "maxAttempts", "acceptors"].forEach(
            function (e) {
              var t = r[e];
              t && s(n, e, t);
            }
    ...
    67: [
      function (e, t, r) {
        var s = e("./shape"),
          n = e("../util"),
          o = n.property,
          a = n.memoizedProperty;
        t.exports = function (e, r, n) {
          var i = this;
          (n = n || {}),
            o(this, "name", r.name || e),
            o(this, "api", n.api, !1),
            (r.http = r.http || {}),
            o(this, "endpoint", r.endpoint),
            o(this, "httpMethod", r.http.method || "POST"),
            o(this, "httpPath", r.http.requestUri || "/"),
            o(this, "authtype", r.authtype || ""),
            o(
              this,
              "endpointDiscoveryRequired",
              r.endpointdiscovery
                ? r.endpointdiscovery.required
                  ? "REQUIRED"
                  : "OPTIONAL"
                : "NULL"
            ),
            ...
            n.documentation &&
              (o(this, "documentation", r.documentation),
              o(this, "documentationUrl", r.documentationUrl)),
            ...
            a(this, "hasEventOutput", function () {
              return (function (e) {
                ...
                for (var n in t)
                  if (!t.hasOwnProperty(n) && !0 === t[n].isEventStream)
                    return !0;
                return !1;
              })(i.output);
            });
        ...
        (n.Endpoint = i({
          ...
          (n.HttpRequest = i({
            ...
            setUserAgent: function () {
              this._userAgent = this.headers[this.getUserAgentHeaderName()] =
                n.util.userAgent();
            },
    ...
    60: [
      function (c, e, t) {
        var p = c("./core"),
          r = c("./sequential_executor"),
          n = c("./discover_endpoint").discoverEndpoint;
        (p.EventListeners = {
          Core: {},
        }),
          (p.EventListeners = {
            Core: new r().addNamedListeners(function (e, t) {
              t("VALIDATE_CREDENTIALS", "validate", function (t, r) {
                if (
                  !t.service.api.signatureVersion &&
                  !t.service.config.signatureVersion
                )
                  return r();
                t.service.config.getCredentials(function (e) {
                  e &&
                    (t.response.error = p.util.error(e, {
                ...
                e("VALIDATE_REGION", "validate", function (e) {
                  e.service.config.region ||
                    ...
                    (e.response.error = p.util.error(new Error(), {
                      code: "ConfigError",
                ...
                e("BUILD_IDEMPOTENCY_TOKENS", "validate", function (e) {
                  if (e.service.api.operations) {
                    ...
                    if (t) {
                      ...
                      if (r.length) {
                        for (
                          var n = p.util.copy(e.params), i = 0, s = r.length;
                          i < s;
                          i++
                        )
                          n[r[i]] || (n[r[i]] = p.util.uuid.v4());
                        e.params = n;
                      }
                    }
                  }
                ...
                e("VALIDATE_PARAMETERS", "validate", function (e) {
                  if (e.service.api.operations) {
                    ...
                    new p.ParamValidator(r).validate(t, e.params);
                  }
                }),
                t("COMPUTE_SHA256", "afterBuild", function (r, n) {
                  if ((r.haltHandlersOnError(), r.service.api.operations)) {
                    var e = r.service.api.operations[r.operation],
                      t = e ? e.authtype : "";
                    if (
                      !r.service.api.signatureVersion &&
                      !t &&
                      !r.service.config.signatureVersion
                    )
                      return n();
                    if (r.service.getSignerClass(r) === p.Signers.V4) {
                      var i = r.httpRequest.body || "";
                      if (0 <= t.indexOf("unsigned-body"))
                        return (
                          (r.httpRequest.headers["X-Amz-Content-Sha256"] =
                            "UNSIGNED-PAYLOAD"),
                          n()
                        );
                      p.util.computeSha256(i, function (e, t) {
                        e
                          ? n(e)
                          : ((r.httpRequest.headers["X-Amz-Content-Sha256"] =
                              t),
                ...
                e("SET_CONTENT_LENGTH", "afterBuild", function (t) {
                  var r = (function (e) {
                    ...
                    n = p.util.getRequestPayloadShape(t);
                  if (void 0 === t.httpRequest.headers["Content-Length"])
                    try {
                      var e = p.util.string.byteLength(t.httpRequest.body);
                      t.httpRequest.headers["Content-Length"] = e;
                    } catch (e) {
                      if (n && n.isStreaming) {
                        if (n.requiresLength) throw e;
                        if (0 <= r.indexOf("unsigned-body"))
                          return void (t.httpRequest.headers[
                            "Transfer-Encoding"
                          ] = "chunked");
                        throw e;
                      }
                ...
                e("RESTART", "restart", function () {
                  ...
                  e &&
                    e.retryable &&
                    ((this.httpRequest = new p.HttpRequest(
                ...
                t("DISCOVER_ENDPOINT", "sign", n, !0),
                t("SIGN", "sign", function (i, s) {
                  var o = i.service,
                    a = (i.service.api.operations || {})[i.operation],
                    e = a ? a.authtype : "";
                  if (
                    !o.api.signatureVersion &&
                    !e &&
                    !o.config.signatureVersion
                  )
                    return s();
                  o.config.getCredentials(function (e, t) {
                    if (e) return (i.response.error = e), s();
                    try {
                      var r = o.getSkewCorrectedDate(),
                        n = new (o.getSignerClass(i))(
                          i.httpRequest,
                          o.api.signingName || o.api.endpointPrefix,
                          {
                            signatureCache: o.config.signatureCache,
                            operation: a,
                            signatureVersion: o.api.signatureVersion,
                          }
                        );
                      n.setServiceClientId(o._clientId),
                        delete i.httpRequest.headers.Authorization,
                        delete i.httpRequest.headers.Date,
                        delete i.httpRequest.headers["X-Amz-Date"],
                        n.addAuthorization(t, r),
                        (i.signedAt = r);
                    } catch (e) {
                      i.response.error = e;
                    }
                ...
                e("VALIDATE_RESPONSE", "validateResponse", function (e) {
                  this.service.successfulResponse(e, this)
                    ? ((e.data = {}), (e.error = null))
                    : ((e.data = null),
                      (e.error = p.util.error(new Error(), {
                        code: "UnknownError",
                        message: "An unknown error occurred.",
                      })));
                }),
                t("SEND", "send", function (o, a) {
                  function n(n) {
                    o.httpResponse.stream = n;
                    var e = o.request.httpRequest.stream,
                      i = o.request.service,
                      t = i.api,
                      r = o.request.operation,
                      s = t.operations[r] || {};
                    n.on("headers", function (e, t, r) {
                      if (
                        (o.request.emit("httpHeaders", [e, t, o, r]),
                        !o.httpResponse.streaming)
                      )
                        if (2 === p.HttpClient.streamsApiVersion) {
                          if (s.hasEventOutput && i.successfulResponse(o))
                            return o.request.emit("httpDone"), void a();
                          n.on("readable", function () {
                            var e = n.read();
                            null !== e && o.request.emit("httpData", [e, o]);
                          });
                        } else
                          n.on("data", function (e) {
                            o.request.emit("httpData", [e, o]);
                          });
                    }),
                      n.on("end", function () {
                        if (!e || !e.didCallback) {
                          if (
                            2 === p.HttpClient.streamsApiVersion &&
                            s.hasEventOutput &&
                            i.successfulResponse(o)
                          )
                            return;
                          o.request.emit("httpDone"), a();
                        }
                      });
                  }
                  function i(e) {
                    if ("RequestAbortedError" !== e.code) {
                      var t =
                        "TimeoutError" === e.code ? e.code : "NetworkingError";
                      e = p.util.error(e, {
                        code: t,
                        region: o.request.httpRequest.region,
                        hostname: o.request.httpRequest.endpoint.hostname,
                        retryable: !0,
                      });
                    }
                    (o.error = e),
                      o.request.emit("httpError", [o.error, o], function () {
                        a();
                      });
                  }
                  function t() {
                    var e,
                      t = p.HttpClient.getInstance(),
                      r = o.request.service.config.httpOptions || {};
                    try {
                      (e = t.handleRequest(o.request.httpRequest, r, n, i)).on(
                        "sendProgress",
                        function (e) {
                          o.request.emit("httpUploadProgress", [e, o]);
                        }
                      ),
                        e.on("receiveProgress", function (e) {
                          o.request.emit("httpDownloadProgress", [e, o]);
                        });
                    } catch (e) {
                      i(e);
                    }
                  }
                  (o.httpResponse._abortCallback = a),
                    (o.error = null),
                    (o.data = null),
                    600 <=
                    (o.request.service.getSkewCorrectedDate() - this.signedAt) /
                      1e3
                ...
                e("HTTP_HEADERS", "httpHeaders", function (e, t, r, n) {
                  (r.httpResponse.statusCode = e),
                    ...
                    (r.httpResponse.body = p.util.buffer.toBuffer("")),
                  ...
                  if (i) {
                    var o = Date.parse(i);
                    s.config.correctClockSkew &&
                      s.isClockSkewed(o) &&
                      s.applyClockOffset(o);
                  }
                }),
                e("HTTP_DATA", "httpData", function (e, t) {
                  if (e) {
                    ...
                    t.httpResponse.buffers.push(p.util.buffer.toBuffer(e));
                  }
                }),
                e("HTTP_DONE", "httpDone", function (e) {
                  if (
                    e.httpResponse.buffers &&
                    0 < e.httpResponse.buffers.length
                  ) {
                    var t = p.util.buffer.concat(e.httpResponse.buffers);
                ...
                e("REDIRECT", "retry", function (e) {
                  e.error &&
                    300 <= e.error.statusCode &&
                    e.error.statusCode < 400 &&
                    e.httpResponse.headers.location &&
                    ((this.httpRequest.endpoint = new p.Endpoint(
                      e.httpResponse.headers.location
                    )),
                  ...
                  e.error &&
                    (e.error.redirect && e.redirectCount < e.maxRedirects
                      ...
                      : e.retryCount < e.maxRetries &&
                        (e.error.retryDelay =
                          this.service.retryDelays(e.retryCount, e.error) ||
                          0));
                }),
                  ...
                  e.error &&
                    ...
                    e.error.retryable && e.retryCount < e.maxRetries
                      ...
                      : e.error.redirect &&
                        ...
                        (e.redirectCount++, (n = !0))),
                    n && 0 <= r ? ((e.error = null), setTimeout(t, r)) : t();
                });
            }),
            CorePost: new r().addNamedListeners(function (e) {
              e("EXTRACT_REQUEST_ID", "extractData", p.util.extractRequestId),
                e(
                  "EXTRACT_REQUEST_ID",
                  "extractError",
                  p.util.extractRequestId
                ),
                e("ENOTFOUND_ERROR", "httpError", function (e) {
                  if ("NetworkingError" === e.code && "ENOTFOUND" === e.errno) {
                    var t =
                      ...
                      e.region +
                      "' region.";
                    this.response.error = p.util.error(new Error(t), {
            ...
            Logger: new r().addNamedListeners(function (e) {
              e("LOG_REQUEST", "complete", function (o) {
                var a = o.request,
                  u = a.service.config.logger;
                if (u) {
                  var e = (function () {
                    var e =
                        (o.request.service.getSkewCorrectedDate().getTime() -
                          a.startTime.getTime()) /
                        1e3,
                      t = !!u.isTTY,
                      r = o.httpResponse.statusCode,
                      n = a.params;
                    a.service.api.operations &&
                      a.service.api.operations[a.operation] &&
                      ...
                      (n = (function r(n, e) {
                        ...
                        switch (n.type) {
                          ...
                          case "list":
                            var s = [];
                            return (
                              p.util.arrayEach(e, function (e, t) {
                                s.push(r(n.member, e));
                              }),
                              s
                            );
                    ...
                    var i = c("util").inspect(n, !0, null),
                      s = "";
                    return (
                      t && (s += "[33m"),
                      (s += "[AWS " + a.service.serviceIdentifier + " " + r),
                      (s +=
                        " " + e.toString() + "s " + o.retryCount + " retries]"),
                      t && (s += "[0;1m"),
                      (s += " " + p.util.string.lowerFirst(a.operation)),
                      (s += "(" + i + ")"),
                      t && (s += "[0m"),
                      s
                    );
                  })();
                  "function" == typeof u.log
                    ? u.log(e)
                    : "function" == typeof u.write && u.write(e + "\n");
                }
              });
            }),
            Json: new r().addNamedListeners(function (e) {
              var t = c("./protocol/json");
              e("BUILD", "build", t.buildRequest),
                e("EXTRACT_DATA", "extractData", t.extractData),
                e("EXTRACT_ERROR", "extractError", t.extractError);
            }),
            Rest: new r().addNamedListeners(function (e) {
              var t = c("./protocol/rest");
              e("BUILD", "build", t.buildRequest),
                e("EXTRACT_DATA", "extractData", t.extractData),
                e("EXTRACT_ERROR", "extractError", t.extractError);
            }),
            RestJson: new r().addNamedListeners(function (e) {
              var t = c("./protocol/rest_json");
              e("BUILD", "build", t.buildRequest),
                e("EXTRACT_DATA", "extractData", t.extractData),
                e("EXTRACT_ERROR", "extractError", t.extractError);
            }),
            RestXml: new r().addNamedListeners(function (e) {
              var t = c("./protocol/rest_xml");
              e("BUILD", "build", t.buildRequest),
                e("EXTRACT_DATA", "extractData", t.extractData),
                e("EXTRACT_ERROR", "extractError", t.extractError);
            }),
            Query: new r().addNamedListeners(function (e) {
              var t = c("./protocol/query");
              e("BUILD", "build", t.buildRequest),
                e("EXTRACT_DATA", "extractData", t.extractData),
                e("EXTRACT_ERROR", "extractError", t.extractError);
            }),
    ...
    88: [
      function (e, t, r) {
        var u = e("./core");
        (u.SequentialExecutor = u.util.inherit({
          constructor: function () {
            this._events = {};
          },
          ...
          removeListener: function (e, t) {
            ...
            if (r) {
              for (var n = r.length, i = -1, s = 0; s < n; ++s)
                r[s] === t && (i = s);
              -1 < i && r.splice(i, 1);
            }
            return this;
          ...
          emit: function (e, t, r) {
            ...
            var n = this.listeners(e),
              i = n.length;
            return this.callListeners(n, t, r), 0 < i;
          },
          callListeners: function (t, r, n, e) {
            function i(e) {
              if (
                e &&
                ((o = u.util.error(o || new Error(), e)),
                s._haltHandlersOnError)
              )
                return n.call(s, o);
              s.callListeners(t, r, n, o);
            }
            for (var s = this, o = e || null; 0 < t.length; ) {
              var a = t.shift();
              if (a._isAsync) return void a.apply(s, r.concat([i]));
              try {
                a.apply(s, r);
              } catch (t) {
                o = u.util.error(o || new Error(), t);
              }
              if (o && s._haltHandlersOnError) return void n.call(s, o);
            }
            n.call(s, o);
          },
          addListeners: function (e) {
            ...
            return (
              ...
              u.util.each(e, function (t, e) {
                "function" == typeof e && (e = [e]),
                  u.util.arrayEach(e, function (e) {
                    r.on(t, e);
                  });
              }),
              r
          ...
          (u.SequentialExecutor.prototype.addListener =
            u.SequentialExecutor.prototype.on),
          (t.exports = u.SequentialExecutor);
      },
      {
        "./core": 39,
      },
      ...
      function (e, t, r) {
        ...
        t.exports = {
                ...
                (function (e) {
                  ...
                  if (i) {
                    ...
                    e.httpRequest.body = r.toXML(
                      ...
                      t.name ||
                        t.shape ||
                        p.string.upperFirst(e.operation) + "Request"
                    );
                })(e);
          },
          extractError: function (t) {
            ...
            l.extractError(t);
            try {
              r = new c.XML.Parser().parse(t.httpResponse.body.toString());
            } catch (e) {
              r = {
                Code: t.httpResponse.statusCode,
                Message: t.httpResponse.statusMessage,
              };
            }
            r.Errors && (r = r.Errors),
              r.Error && (r = r.Error),
              r.Code
                ? (t.error = p.error(new Error(), {
                    code: r.Code,
                    message: r.Message,
                  }))
                : (t.error = p.error(new Error(), {
          ...
          extractData: function (e) {
            ...
            if (o) {
              ...
              a.isEventStream
                ? ((t = new c.XML.Parser()),
                  (e.data[o] = p.createEventStream(
                    2 === c.HttpClient.streamsApiVersion
                ...
                : "structure" === a.type
                ? ((t = new c.XML.Parser()),
                  (e.data[o] = t.parse(n.toString(), a)))
                : "binary" === a.type || a.isStreaming
                ? (e.data[o] = n)
                : (e.data[o] = a.toType(n));
            } else if (0 < n.length) {
              var u = (t = new c.XML.Parser()).parse(n.toString(), s);
              p.update(e.data, u);
            }
          },
        };
      ...
      function (e, t, r) {
        function o(e, t) {
          if (
            ...
            !e.httpRequest.headers["Content-Type"])
          ) {
        ...
        t.exports = {
          buildRequest: function (e) {
            c.buildRequest(e),
              ["HEAD", "DELETE"].indexOf(e.httpRequest.method) < 0 &&
                (function (e) {
                  var t = new a(),
                  ...
                  if (r.payload) {
                    ...
                    "structure" === i.type
                      ...
                      : ((e.httpRequest.body = n),
                        ("binary" === i.type || i.isStreaming) && o(e, !0));
                  } else {
                    var s = t.build(e.params, r);
                    ("{}" === s && "GET" === e.httpRequest.method) ||
              ...
              if (i.isEventStream)
                (o = new l()),
                  (e.data[payload] = u.createEventStream(
                    2 === AWS.HttpClient.streamsApiVersion
                      ? e.httpResponse.stream
                      : s,
                    o,
                    i
                  ));
              else if ("structure" === i.type || "list" === i.type) {
                var o = new l();
                e.data[n.payload] = o.parse(s, i);
              } else
                "binary" === i.type || i.isStreaming
                  ? (e.data[n.payload] = s)
                  : (e.data[n.payload] = i.toType(s));
            } else {
              var a = e.data;
              p.extractData(e), (e.data = u.merge(a, e.data));
            }
          },
        };
      },
      ...
      function (e, t, r) {
        function u(e, t, r, i) {
          ...
          var o = {},
            a = !1;
          if (
            (c.each(r.members, function (e, t) {
              var r = i[e];
              if (null != r)
                if ("uri" === t.location) {
                  var n = new RegExp("\\{" + t.name + "(\\+)?\\}");
                  s = s.replace(n, function (e, t) {
                    return (t ? c.uriEscapePath : c.uriEscape)(String(r));
                  });
                } else
                  "querystring" === t.location &&
                    ...
                    "list" === t.type
                      ? (o[t.name] = r.map(function (e) {
                          return c.uriEscape(
                            t.member.toWireFormat(e).toString()
                          );
                        }))
                      : "map" === t.type
                      ? c.each(r, function (e, t) {
                          Array.isArray(t)
                            ...
                            : (o[e] = c.uriEscape(String(t)));
                        })
                      : (o[t.name] = c.uriEscape(
                          t.toWireFormat(r).toString()
                        )));
            }),
            a)
          ) {
            s += 0 <= s.indexOf("?") ? "&" : "?";
            var n = [];
            c.arrayEach(Object.keys(o).sort(), function (e) {
              Array.isArray(o[e]) || (o[e] = [o[e]]);
              for (var t = 0; t < o[e].length; t++)
                n.push(c.uriEscape(String(e)) + "=" + o[e][t]);
            }),
              (s += n.join("&"));
          }
          return s;
        ...
        t.exports = {
          buildRequest: function (e) {
            var n, t, r, i, s, o, a;
            ((a = e).httpRequest.method =
              a.service.api.operations[a.operation].httpMethod),
              (i = (r = e).service.api.operations[r.operation]),
              (s = i.input),
              (o = u(r.httpRequest.endpoint.path, i.httpPath, s, r.params)),
              (r.httpRequest.path = o),
              (t = (n = e).service.api.operations[n.operation]),
              c.each(t.input.members, function (e, r) {
                var t = n.params[e];
                null != t &&
                  ("headers" === r.location && "map" === r.type
                    ? c.each(t, function (e, t) {
                        n.httpRequest.headers[r.name + e] = t;
                      })
                    : "header" === r.location &&
                      ((t = r.toWireFormat(t).toString()),
                      r.isJsonValue && (t = c.base64.encode(t)),
                      (n.httpRequest.headers[r.name] = t)));
              }),
              p(e);
          },
          ...
          extractData: function (e) {
            var t = e.request,
              ...
              u = {};
            c.each(a.headers, function (e, t) {
              u[e.toLowerCase()] = t;
            }),
              c.each(r.members, function (n, e) {
                var t = (e.name || n).toLowerCase();
                if ("headers" === e.location && "map" === e.type) {
                  o[n] = {};
                  var r = e.isLocationName ? e.name : "",
                    i = new RegExp("^" + r + "(.+)", "i");
                  c.each(a.headers, function (e, t) {
                    var r = e.match(i);
                    null !== r && (o[n][r[1]] = t);
                  ...
                  if (void 0 !== u[t]) {
                    var s = e.isJsonValue ? c.base64.decode(u[t]) : u[t];
                    o[n] = e.toType(s);
                  }
                } else
                  "statusCode" === e.location &&
                    (o[n] = parseInt(a.statusCode, 10));
              }),
              (e.data = o);
          },
          generateURI: u,
    ...
    75: [
      function (e, t, r) {
        var u = e("../core"),
          c = e("../util"),
          n = e("../query/query_param_serializer"),
          p = e("../model/shape"),
          i = e("./helpers").populateHostPrefix;
        t.exports = {
          buildRequest: function (e) {
            var t = e.service.api.operations[e.operation],
              r = e.httpRequest;
            (r.headers["Content-Type"] =
              ...
              new n().serialize(e.params, t.input, function (e, t) {
                r.params[e] = t;
              }),
              (r.body = c.queryParamsToString(r.params)),
              i(e);
          },
          extractError: function (e) {
            var t,
          ...
          extractData: function (e) {
            ...
            if (n.resultWrapper) {
              ...
              (i.members[n.resultWrapper] = r),
                (i.memberNames = [n.resultWrapper]),
                c.property(r, "name", r.resultWrapper),
                (r = i);
            }
            var s = new u.XML.Parser();
            if (r && r.members && !r.members._XAMZRequestId) {
              ...
              r.members._XAMZRequestId = o;
            }
            var a = s.parse(e.httpResponse.body.toString(), r);
            (e.requestId = a._XAMZRequestId || a.requestId),
              a._XAMZRequestId && delete a._XAMZRequestId,
              n.resultWrapper &&
                a[n.resultWrapper] &&
                (c.update(a, a[n.resultWrapper]), delete a[n.resultWrapper]),
              (e.data = a);
          },
        };
      },
          ...
          null != t &&
            ("structure" === r.type
              ...
              ? (function (i, e, s, o) {
                  var a = s.member || {};
                  0 !== e.length
                    ? h.arrayEach(e, function (e, t) {
                        var r = "." + (t + 1);
                        if ("ec2" === s.api.protocol) r += "";
                        else if (s.flattened) {
                          if (a.name) {
                            var n = i.split(".");
                            n.pop(), n.push(c(a)), (i = n.join("."));
                          }
                        } else r = "." + (a.name ? a.name : "member") + r;
                        l(i + r, e, a, o);
                      })
                    : o.call(this, i, null);
                })(e, t, r, n)
              ...
              ? ((s = e),
                ...
                h.each(i, function (e, t) {
                  var r = (o.flattened ? "." : ".entry.") + u++ + ".",
                    n = r + (o.key.name || "key"),
                    i = r + (o.value.name || "value");
                  l(s + n, e, o.key, a), l(s + i, t, o.value, a);
                }))
    ...
    70: [
      function (e, t, r) {
        function o(e, t, r) {
          null != r && m.property.apply(this, arguments);
        }
        function a(e, t) {
          e.constructor.prototype[t] ||
            m.memoizedProperty.apply(this, arguments);
        }
        function u(e, t, r) {
          (t = t || {}),
            ...
            o(
              ...
              "isSensitive",
              !0 === e.sensitive ||
                (e.prototype && !0 === e.prototype.sensitive)
            ),
            ...
            t.documentation &&
              (o(this, "documentation", e.documentation),
          ...
          c.apply(this, arguments),
            ...
            r.members &&
              (o(
                this,
                "members",
                new d(r.members, n, function (e, t) {
                  return u.create(t, n, e);
                })
              ),
              a(this, "memberNames", function () {
                return r.xmlOrder || Object.keys(r.members);
              }),
              r.event &&
                (a(this, "eventPayloadMemberName", function () {
                  for (
                    var e = s.members, t = s.memberNames, r = 0, n = t.length;
                    r < n;
                    r++
                  )
                    if (e[t[r]].isEventPayload) return t[r];
                }),
                a(this, "eventHeaderMemberNames", function () {
                  for (
                    ...
                    e[t[n]].isEventHeader && r.push(t[n]);
                  return r;
                }))),
            r.required &&
              (o(this, "required", r.required),
              o(
                this,
                "isRequired",
                function (e) {
                  if (!i) {
                    i = {};
                    for (var t = 0; t < r.required.length; t++)
                      i[r.required[t]] = !0;
                  }
                  return i[e];
                },
            ...
            o(this, "resultWrapper", r.resultWrapper || null),
            r.payload && o(this, "payload", r.payload),
            "string" == typeof r.xmlNamespace
              ? o(this, "xmlNamespaceUri", r.xmlNamespace)
              : "object" == typeof r.xmlNamespace &&
                (o(this, "xmlNamespacePrefix", r.xmlNamespace.prefix),
                o(this, "xmlNamespaceUri", r.xmlNamespace.uri));
        }
        function i(e, t) {
          var r = this,
            n = !this.isShape;
        ...
        function s(e, t) {
          ...
          c.apply(this, arguments),
            ...
            e.key &&
              a(this, "key", function () {
                return u.create(e.key, t);
              }),
            e.value &&
              a(this, "value", function () {
                return u.create(e.value, t);
              });
        }
        function p() {
          u.apply(this, arguments);
          ...
          (this.toType = function (e) {
            return (
              (e = this.api && -1 < t.indexOf(this.api.protocol) ? e || "" : e),
              this.isJsonValue
                ? JSON.parse(e)
        ...
        function l() {
          u.apply(this, arguments),
            (this.toType = function (e) {
              var t = m.base64.decode(e);
              if (
                this.isSensitive &&
                m.isNode() &&
                "function" == typeof m.Buffer.alloc
              ) {
                var r = m.Buffer.alloc(t.length, t);
                t.fill(0), (t = r);
              }
              return t;
            }),
            (this.toWireFormat = m.base64.encode);
        }
        function h() {
        ...
        (u.normalizedTypes = {
          ...
          (u.types = {
            ...
            timestamp: function (e) {
              var t = this;
              if ((u.apply(this, arguments), e.timestampFormat))
              ...
              (this.toType = function (e) {
                return null == e
                  ...
                  ? m.date.parseTimestamp(e)
                  : null;
              }),
                (this.toWireFormat = function (e) {
                  return m.date.format(e, t.timestampFormat);
                });
            },
            float: function () {
              u.apply(this, arguments),
          ...
          (u.create = function (e, t, r) {
            ...
            var o = e.type;
            if (
              (u.normalizedTypes[e.type] &&
                (e.type = u.normalizedTypes[e.type]),
              u.types[e.type])
            )
              return new u.types[e.type](e, t, r);
            throw new Error("Unrecognized shape type: " + o);
          }),
          (u.shapes = {
            StructureShape: n,
            ListShape: i,
    ...
    66: [
      function (e, t, r) {
        ...
        t.exports = function (e, t, r, n, i) {
          for (var s in ((n = n || String), e))
            Object.prototype.hasOwnProperty.call(e, s) &&
              (o.call(this, s, e[s], r, n), i && i(s, e[s]));
        };
      },
      {
        "../util": 118,
    ...
    74: [
      function (e, t, r) {
        var i = e("../util"),
          a = e("../json/builder"),
          s = e("../json/parser"),
          u = e("./helpers").populateHostPrefix;
        t.exports = {
          buildRequest: function (e) {
            var t = e.httpRequest,
              r = e.service.api,
          ...
          extractData: function (e) {
            ...
            if (!1 === e.request.service.config.convertResponseTypes)
              ...
              var r =
                  e.request.service.api.operations[e.request.operation]
                    .output || {},
                n = new s();
              e.data = n.parse(t, r);
            }
      ...
      function (e, t, r) {
        ...
        t.exports = {
          populateHostPrefix: function (e) {
            ...
            if (
              ((r = (t = e).service.api),
              (n = r.operations[t.operation]),
              (i =
                r.endpointOperation &&
                r.endpointOperation === y.string.lowerFirst(n.name)),
              "NULL" !== n.endpointDiscoveryRequired || !0 === i)
            )
              return e;
            if (f.endpoint && f.endpoint.hostPrefix) {
              var d = f.endpoint.hostPrefix,
                m =
                  ((p = d),
                  (l = e.params),
                  (h = f.input),
                  y.each(h.members, function (e, t) {
                    if (!0 === t.hostLabel) {
                      if ("string" != typeof l[e] || "" === l[e])
                        throw y.error(new Error(), {
                          message:
                            "Parameter " + e + " should be a non-empty string.",
                  ...
                  p);
              (u = e.httpRequest.endpoint),
                (c = m),
                u.host && (u.host = c + u.host),
                u.hostname && (u.hostname = c + u.hostname),
                (s = e.httpRequest.endpoint.hostname),
                (o = s.split(".")),
                (a = /^[a-zA-Z0-9]{1}$|^[a-zA-Z0-9][a-zA-Z0-9\-]*[a-zA-Z0-9]$/),
                y.arrayEach(o, function (e) {
                  if (!e.length || e.length < 1 || 63 < e.length)
                    throw y.error(new Error(), {
                  ...
                  if (null != s) {
                    ...
                    return (
                      u.each(t, function (e, t) {
                        var r = t.isLocationName ? t.name : e;
              ...
              case "list":
                return (function (e, r) {
                  if (null != e) {
                    var n = [];
                    return (
                      u.arrayEach(e, function (e) {
                        var t = a(e, r.member);
                        void 0 === t ? n.push(null) : n.push(t);
                      }),
                      n
                    );
                  }
        ...
        function h(e, t) {
          if (t && null != e)
            switch (t.type) {
              case "structure":
                return (
                  ...
                  f.each(c, function (e, t) {
                    var r = p.members[e];
                    if (r) {
                      if ("body" !== r.location) return;
                      var n = r.isLocationName ? r.name : e,
                        i = h(t, r);
                      void 0 !== i && (l[n] = i);
                    }
                  }),
              ...
              default:
                return (r = e), t.toWireFormat(r);
            }
          var r, n, i, s, o, a, u, c, p, l;
        }
        var f = e("../util");
        (n.prototype.build = function (e, t) {
          return JSON.stringify(h(e, t));
        }),
          (t.exports = n);
      },
      {
        ...
        (function (s) {
            ...
            return (
              (function n(i, s, o) {
                o &&
                  ...
                  o.required &&
                  0 < o.required.length &&
                  m.arrayEach(o.required, function (e) {
                    var t = o.members[e];
          ...
          function i(e) {
            var t = e.service,
              ...
              i = h(e, n ? n.input : void 0),
              s = l(e);
            0 < Object.keys(i).length &&
              ((s = m.update(s, i)), n && (s.operation = n.name));
            var o = d.endpointCache.get(s);
            if (!o || 1 !== o.length || "" !== o[0].Address)
              if (o && 0 < o.length) e.httpRequest.updateEndpoint(o[0].Address);
              else {
                var a = t.makeRequest(r.endpointOperation, {
                  Operation: n.name,
                  Identifiers: i,
                });
                f(a),
                  ...
                  a.removeListener("retry", d.EventListeners.Core.RETRY_CHECK),
                  d.endpointCache.put(s, [
                    {
                      Address: "",
                  ...
                  a.send(function (e, t) {
                    t && t.Endpoints
                      ? d.endpointCache.put(s, t.Endpoints)
                      : e &&
                        d.endpointCache.put(s, [
                          {
                            Address: "",
          ...
          function o(i, s) {
            var e = i.service,
              t = e.api,
              r = t.operations ? t.operations[i.operation] : void 0,
              n = r ? r.input : void 0,
              o = h(i, n),
              a = l(i);
            0 < Object.keys(o).length &&
              ((a = m.update(a, o)), r && (a.operation = r.name));
            var u = d.EndpointCache.getKeyString(a),
              c = d.endpointCache.get(u);
            ...
            if (c && 0 < c.length)
              i.httpRequest.updateEndpoint(c[0].Address), s();
            else {
              var p = e.makeRequest(t.endpointOperation, {
                Operation: r.name,
                Identifiers: o,
              });
              p.removeListener(
                ...
                p.send(function (t, r) {
                  if (t) {
                    ...
                    if (
                      ((i.response.error = m.error(t, n)),
                      d.endpointCache.remove(a),
                      y[u])
                    ) {
                      var e = y[u];
                      m.arrayEach(e, function (e) {
                        (e.request.response.error = m.error(t, n)),
                          e.callback();
                      }),
                        delete y[u];
                    }
                    ...
                    r &&
                    (d.endpointCache.put(u, r.Endpoints),
                    i.httpRequest.updateEndpoint(r.Endpoints[0].Address),
                    y[u])
                  ) {
                    e = y[u];
                    m.arrayEach(e, function (e) {
                      e.request.httpRequest.updateEndpoint(
                        r.Endpoints[0].Address
                      ),
                        e.callback();
                    }),
                      delete y[u];
          ...
          function f(e) {
            ...
            t &&
              ...
              (e.httpRequest.headers["x-amz-api-version"] = t);
          }
          function a(e) {
            var t = e.error,
              r = e.httpResponse;
            if (
              t &&
              ("InvalidEndpointException" === t.code || 421 === r.statusCode)
            ) {
              var n = e.request,
                i = n.service.api.operations || {},
                s = h(n, i[n.operation] ? i[n.operation].input : void 0),
                o = l(n);
              0 < Object.keys(s).length &&
                ((o = m.update(o, s)),
                i[n.operation] && (o.operation = i[n.operation].name)),
                d.endpointCache.remove(o);
            }
          }
          function u(e) {
            return 0 <= ["false", "0"].indexOf(e);
          }
          var d = e("./core"),
            m = e("./util"),
            c = [
          ...
          t.exports = {
              ...
              if (
                (function (e) {
                  ...
                  return Boolean(
                    d.config.endpoint ||
                      t.endpoint ||
                      (e._originalConfig && e._originalConfig.endpoint)
                  );
                })(r) ||
                e.isPresigned()
              )
              ...
              if (
                !(function (e) {
                  ...
                  for (var t = 0; t < c.length; t++) {
                    var r = c[t];
                    if (Object.prototype.hasOwnProperty.call(s.env, r)) {
                      if ("" === s.env[r] || void 0 === s.env[r])
                        throw m.error(new Error(), {
                          code: "ConfigurationException",
                          message:
                  ...
                  try {
                    n = d.util.iniLoader
                      ? d.util.iniLoader.loadFrom({
                          isConfig: !0,
                          filename: s.env[d.util.sharedConfigFileEnv],
                        })
                      : {};
                  } catch (e) {}
                  var i = n[s.env.AWS_PROFILE || d.util.defaultProfile] || {};
                  if (
                    Object.prototype.hasOwnProperty.call(
                      i,
                    ...
                    if (void 0 === i.endpoint_discovery_enabled)
                      throw m.error(new Error(), {
                        code: "ConfigurationException",
                        message:
                          "config file entry 'endpoint_discovery_enabled' cannot be set to nothing",
                      });
                    if (!u(i.endpoint_discovery_enabled)) return !0;
                  }
                  return !1;
                })(e)
              )
            ...
            requiredDiscoverEndpoint: o,
            optionalDiscoverEndpoint: i,
            marshallCustomIdentifiers: h,
            getCacheKey: l,
            invalidateCachedEndpoint: a,
          };
        }).call(this, e("_process"));
      },
      {
        ...
        (function (a, t) {
          var u,
            p = {
              environment: "nodejs",
              engine: function () {
                if (p.isBrowser() && "undefined" != typeof navigator)
                  return navigator.userAgent;
                var e = a.platform + "/" + a.version;
                return (
                  a.env.AWS_EXECUTION_ENV &&
                    (e += " exec-env/" + a.env.AWS_EXECUTION_ENV),
                  e
                );
              },
              userAgent: function () {
                var e = p.environment,
                  t = "aws-sdk-" + e + "/" + s("./core").VERSION;
                return "nodejs" === e && (t += " " + p.engine()), t;
              },
              uriEscape: function (e) {
                var t = encodeURIComponent(e);
                return (t = t.replace(/[^A-Za-z0-9_.~\-%]+/g, escape)).replace(
                  /[*]/g,
                  function (e) {
              ...
              uriEscapePath: function (e) {
                var t = [];
                return (
                  p.arrayEach(e.split("/"), function (e) {
                    t.push(p.uriEscape(e));
                  }),
                  t.join("/")
                );
              },
              urlParse: function (e) {
                return p.url.parse(e);
              },
              urlFormat: function (e) {
                return p.url.format(e);
              },
              queryStringParse: function (e) {
                return p.querystring.parse(e);
              },
              queryParamsToString: function (s) {
                var o = [],
                  a = p.uriEscape,
                  e = Object.keys(s).sort();
                return (
                  p.arrayEach(e, function (e) {
                    var t = s[e],
                      r = a(e),
                      n = r + "=";
                    if (Array.isArray(t)) {
                      var i = [];
                      p.arrayEach(t, function (e) {
                        i.push(a(e));
                      }),
                        (n = r + "=" + i.sort().join("&" + r + "="));
                    } else null != t && (n = r + "=" + a(t));
              ...
              readFileSync: function (e) {
                return p.isBrowser() ? null : s("fs").readFileSync(e, "utf-8");
              },
              base64: {
                encode: function (e) {
                  if ("number" == typeof e)
                    throw p.error(
                      new Error("Cannot base64 encode number " + e)
                    );
                  return null == e
                    ? e
                    : p.buffer.toBuffer(e).toString("base64");
                },
                decode: function (e) {
                  if ("number" == typeof e)
                    throw p.error(
                      new Error("Cannot base64 decode number " + e)
                    );
                  return null == e ? e : p.buffer.toBuffer(e, "base64");
                },
              },
              buffer: {
                toBuffer: function (e, t) {
                  return "function" == typeof p.Buffer.from &&
                    p.Buffer.from !== Uint8Array.from
                    ? p.Buffer.from(e, t)
                    : new p.Buffer(e, t);
                },
                alloc: function (e, t, r) {
                  ...
                  if ("function" == typeof p.Buffer.alloc)
                    return p.Buffer.alloc(e, t, r);
                  var n = new p.Buffer(e);
                  return (
                    void 0 !== t &&
                      "function" == typeof n.fill &&
                      n.fill(t, void 0, void 0, r),
                    n
                  );
                },
                toStream: function (r) {
                  p.Buffer.isBuffer(r) || (r = p.buffer.toBuffer(r));
                  var n = new p.stream.Readable(),
                    i = 0;
                  return (
                    (n._read = function (e) {
                      if (i >= r.length) return n.push(null);
                      var t = i + e;
                ...
                concat: function (e) {
                  ...
                  for (r = p.buffer.alloc(n), t = 0; t < e.length; t++)
                    e[t].copy(r, i), (i += e[t].length);
                  return r;
                },
              },
              string: {
                byteLength: function (e) {
                  if (null == e) return 0;
                  if (
                    ("string" == typeof e && (e = p.buffer.toBuffer(e)),
                  ...
                  if ("string" == typeof e.path)
                    return s("fs").lstatSync(e.path).size;
                  throw p.error(new Error("Cannot determine length of " + e), {
                    object: e,
                  });
                },
              ...
              ini: {
                parse: function (e) {
                  var n,
                    i = {};
                  return (
                    p.arrayEach(e.split(/\r?\n/), function (e) {
                      var t = (e = e.split(/(^|\s)[;#]/)[0]).match(
                        /^\s*\[([^\[\]]+)\]\s*$/
                      );
                      if (t) n = t[1];
                      else if (n) {
                        var r = e.match(/^\s*(.+?)\s*=\s*(.+?)\s*$/);
                        r && ((i[n] = i[n] || {}), (i[n][r[1]] = r[2]));
                      }
                    }),
                    i
                  );
              ...
              date: {
                getDate: function () {
                  return (
                    u || (u = s("./core")),
                    u.config.systemClockOffset
                      ? new Date(
                          new Date().getTime() + u.config.systemClockOffset
                        )
                      : new Date()
                  );
                },
                iso8601: function (e) {
                  return (
                    void 0 === e && (e = p.date.getDate()),
                    e.toISOString().replace(/\.\d{3}Z$/, "Z")
                  );
                },
                rfc822: function (e) {
                  return (
                    void 0 === e && (e = p.date.getDate()), e.toUTCString()
                  );
                },
                unixTimestamp: function (e) {
                  return (
                    void 0 === e && (e = p.date.getDate()), e.getTime() / 1e3
                  );
                },
                from: function (e) {
                ...
                format: function (e, t) {
                  return t || (t = "iso8601"), p.date[t](p.date.from(e));
                },
                parseTimestamp: function (e) {
                  ...
                  throw p.error(new Error("unhandled timestamp format: " + e), {
              ...
              crypto: {
                ...
                hmac: function (e, t, r, n) {
                  return (
                    ...
                    "buffer" === r && (r = void 0),
                    n || (n = "sha256"),
                    "string" == typeof t && (t = p.buffer.toBuffer(t)),
                    p.crypto.lib.createHmac(n, e).update(t).digest(r)
                  );
                },
                md5: function (e, t, r) {
                  return p.crypto.hash("md5", e, t, r);
                },
                sha256: function (e, t, r) {
                  return p.crypto.hash("sha256", e, t, r);
                },
                hash: function (e, t, r, n) {
                  var i = p.crypto.createHash(e);
                  r || (r = "binary"),
                    "buffer" === r && (r = void 0),
                    "string" == typeof t && (t = p.buffer.toBuffer(t));
                  var s = p.arraySliceFn(t),
                    o = p.Buffer.isBuffer(t);
                  if (
                    (p.isBrowser() &&
                    ...
                    if (!n || !s || o || "undefined" == typeof FileReader) {
                      p.isBrowser() &&
                        "object" == typeof t &&
                        !o &&
                        (t = new p.Buffer(new Uint8Array(t)));
                      var a = i.update(t).digest(r);
                      return n && n(null, a), a;
                    }
                    var u = 0,
                      c = new FileReader();
                    (c.onerror = function () {
                      ...
                      (c.onload = function () {
                        var e = new p.Buffer(new Uint8Array(c.result));
                        i.update(e), (u += e.length), c._continueReading();
                      }),
                      (c._continueReading = function () {
                        if (u >= t.size) n(null, i.digest(r));
                        else {
                          var e = u + 524288;
                          e > t.size && (e = t.size),
                            c.readAsArrayBuffer(s.call(t, u, e));
                        }
                      }),
                      c._continueReading();
                  }
                ...
                createHash: function (e) {
                  return p.crypto.lib.createHash(e);
                },
              },
              abort: {},
              each: function (e, t) {
                for (var r in e)
                  if (Object.prototype.hasOwnProperty.call(e, r)) {
                    if (t.call(this, r, e[r]) === p.abort) break;
                  }
              },
              arrayEach: function (e, t) {
                for (var r in e)
                  if (Object.prototype.hasOwnProperty.call(e, r)) {
                    if (t.call(this, e[r], parseInt(r, 10)) === p.abort) break;
                  }
              },
              update: function (r, e) {
                return (
              ...
              isType: function (e, t) {
                return (
                  "function" == typeof t && (t = p.typeName(t)),
              ...
              inherit: function (e, t) {
                ...
                return (
                  ...
                  p.update(t.constructor.prototype, t),
                ...
                if (i.payload && !n.hasEventOutput) {
                  ...
                  "structure" === s.type &&
                    p.each(o, function (e, t) {
                      p.property(r.data, e, t, !1);
                    });
                }
              },
              computeSha256: function (e, r) {
                if (p.isNode()) {
                  var t = p.stream.Stream,
                    n = s("fs");
                  if ("function" == typeof t && e instanceof t) {
                    if ("string" != typeof e.path)
                      return r(
                        new Error(
                    ...
                    var i = {};
                    "number" == typeof e.start && (i.start = e.start),
                      "number" == typeof e.end && (i.end = e.end),
                      (e = n.createReadStream(e.path, i));
                  }
                }
                p.crypto.sha256(e, "hex", function (e, t) {
                  e ? r(e) : r(null, t);
                });
              },
              isClockSkewed: function (e) {
                if (e)
                  return (
                    p.property(
                      u.config,
                      "isClockSkewed",
                      3e5 <= Math.abs(new Date().getTime() - e),
                      !1
                    ),
                    u.config.isClockSkewed
                  );
              },
              applyClockOffset: function (e) {
                e && (u.config.systemClockOffset = e - new Date().getTime());
              },
              ...
              addPromises: function (e, t) {
                ...
                void 0 === t &&
                  u &&
                  u.config &&
                  (t = u.config.getPromisesDependency()),
                  void 0 === t &&
                ...
                for (var n = 0; n < e.length; n++) {
                  var i = e[n];
                  r
                    ? i.deletePromisesFromClass && i.deletePromisesFromClass()
                    : i.addPromisesToClass && i.addPromisesToClass(t);
                }
              },
              promisifyMethod: function (i, r) {
                return function () {
                  var e = this,
              ...
              isDualstackAvailable: function (e) {
                if (!e) return !1;
                var t = s("../apis/metadata.json");
                return (
                  "string" != typeof e && (e = e.serviceIdentifier),
                  !(
                    "string" != typeof e ||
                    !t.hasOwnProperty(e) ||
                    !t[e].dualstackAvailable
                  )
                );
              },
              ...
              handleRequestWithRetries: function (e, n, s) {
                n || (n = {});
                var t = u.HttpClient.getInstance(),
                  r = n.httpOptions || {},
                  i = 0,
                  o = function (e) {
                    var t = n.maxRetries || 0;
                    e && "TimeoutError" === e.code && (e.retryable = !0);
                    var r = p.calculateRetryDelay(i, n.retryDelayOptions, e);
                    e && e.retryable && i < t && 0 <= r
                      ? (i++, setTimeout(a, r + (e.retryAfter || 0)))
                      : s(e);
                  },
                  a = function () {
                    var i = "";
                        ...
                        n.on("data", function (e) {
                          ...
                          n.on("end", function () {
                            ...
                            if (e < 300) s(null, i);
                              ...
                              var t =
                                  1e3 *
                                    parseInt(n.headers["retry-after"], 10) || 0,
                                r = p.error(new Error(), {
                                  statusCode: e,
                                  retryable: 500 <= e || 429 === e,
                                });
                              t && r.retryable && (r.retryAfter = t), o(r);
                            }
                          });
                      },
                      o
              ...
              defer: function (e) {
                "object" == typeof a && "function" == typeof a.nextTick
                  ? a.nextTick(e)
                  : "function" == typeof t
                  ? t(e)
                  : setTimeout(e, 0);
              ...
              getRequestPayloadShape: function (e) {
                ...
                if (t) {
                  var r = (t || {})[e.operation];
                  if (r && r.input && r.input.payload)
                    return r.input.members[r.input.payload];
                }
              },
              getProfilesFromSharedConfig: function (e, t) {
                var r = {},
                  n = {};
                if (a.env[p.configOptInEnv])
                  n = e.loadFrom({
                    isConfig: !0,
                    filename: a.env[p.sharedConfigFileEnv],
                  });
                for (
                  var i = e.loadFrom({
                      filename:
                        t ||
                        (a.env[p.configOptInEnv] &&
                          a.env[p.sharedCredentialsFileEnv]),
                    }),
                    s = 0,
                    o = Object.keys(n);
                  s < o.length;
                  ...
                  r[o[s]] = n[o[s]];
                for (s = 0, o = Object.keys(i); s < o.length; s++)
                  r[o[s]] = i[o[s]];
                return r;
              },
              ARN: {
                validate: function (e) {
                  return (
                    e && 0 === e.indexOf("arn:") && 6 <= e.split(":").length
                  );
                },
                parse: function (e) {
                  var t = e.split(":");
                ...
                build: function (e) {
                  if (
                    ...
                    throw p.error(new Error("Input ARN object is invalid"));
                  return (
                    "arn:" +
                    (e.partition || "aws") +
                    ":" +
          ...
          e.exports = p;
        }).call(this, s("_process"), s("timers").setImmediate);
      },
      {
        "../apis/metadata.json": 26,
        "./core": 39,
    ...
    37: [
      function (e, t, r) {
        ...
        e("./credentials"),
          ...
          (s.Config = s.util.inherit({
            constructor: function (r) {
              void 0 === r && (r = {}),
                (r = this.extractCredentials(r)),
                s.util.each.call(this, this.keys, function (e, t) {
                  this.set(e, r[e], t);
                });
            },
            getCredentials: function (t) {
              function r(e) {
                t(e, e ? null : i.credentials);
              }
              function n(e, t) {
                return new s.util.error(t || new Error(), {
                  code: "CredentialsError",
                  message: e,
                ...
                ? "function" == typeof i.credentials.get
                      ...
                      e &&
                        (e = n(
                          "Could not load credentials from " +
                            i.credentials.constructor.name,
                          e
                        )),
                        r(e);
                    })
                  : ((e = null),
                    (i.credentials.accessKeyId &&
                      i.credentials.secretAccessKey) ||
                      (e = n("Missing credentials")),
                    r(e))
                : i.credentialProvider
                ? i.credentialProvider.resolve(function (e, t) {
                    e &&
                      (e = n(
            ...
            update: function (e, r) {
              (r = r || !1),
                ...
                s.util.each.call(this, e, function (e, t) {
                  (r ||
                    Object.prototype.hasOwnProperty.call(this.keys, e) ||
                    s.Service.hasService(e)) &&
                    this.set(e, t);
                });
            },
            loadFromPath: function (e) {
              this.clear();
              var r = JSON.parse(s.util.readFileSync(e)),
                t = new s.FileSystemCredentials(e),
                n = new s.CredentialProviderChain();
              return (
                n.providers.unshift(t),
            ...
            clear: function () {
              s.util.each.call(this, this.keys, function (e) {
                delete this[e];
              }),
            ...
            extractCredentials: function (e) {
              return (
                e.accessKeyId &&
                  e.secretAccessKey &&
                  ((e = s.util.copy(e)).credentials = new s.Credentials(e)),
                e
              );
            },
            setPromisesDependency: function (e) {
              null === (n = e) && "function" == typeof Promise && (n = Promise);
              var t = [s.Request, s.Credentials, s.CredentialProviderChain];
              s.S3 &&
                (t.push(s.S3),
                s.S3.ManagedUpload && t.push(s.S3.ManagedUpload)),
                s.util.addPromises(t, n);
            },
    ...
    43: [
      function (e, t, r) {
        ...
        (a.CredentialProviderChain = a.util.inherit(a.Credentials, {
          constructor: function (e) {
            (this.providers =
              e || a.CredentialProviderChain.defaultProviders.slice(0)),
              (this.resolveCallbacks = []);
          },
          resolve: function (e) {
            var i = this;
            if (0 === i.providers.length)
              return e(new Error("No providers")), i;
            if (1 === i.resolveCallbacks.push(e)) {
              var s = 0,
                o = i.providers.slice(0);
              !(function t(r, n) {
                if ((!r && n) || s === o.length)
                  return (
                    a.util.arrayEach(i.resolveCallbacks, function (e) {
                      e(r, n);
                    }),
                    void (i.resolveCallbacks.length = 0)
                  );
                var e = o[s++];
                (n = "function" == typeof e ? e.call() : e).get
                  ? n.get(function (e) {
                      t(e, e ? null : n);
                    })
                  : t(null, n);
          ...
          (a.CredentialProviderChain.addPromisesToClass = function (e) {
            this.prototype.resolvePromise = a.util.promisifyMethod(
              "resolve",
              e
            );
          }),
          (a.CredentialProviderChain.deletePromisesFromClass = function () {
            delete this.prototype.resolvePromise;
          }),
          a.util.addPromises(a.CredentialProviderChain);
      },
      {
        "../core": 39,
      },
    ...
    40: [
      function (e, t, r) {
        var i = e("./core");
        (i.Credentials = i.util.inherit({
          constructor: function () {
            if (
              (i.util.hideProperties(this, ["secretAccessKey"]),
              (this.expired = !1),
          ...
          needsRefresh: function () {
            var e = i.util.date.getDate().getTime(),
          ...
          coalesceRefresh: function (e, r) {
            var n = this;
            1 === n.refreshCallbacks.push(e) &&
              n.load(function (t) {
                i.util.arrayEach(n.refreshCallbacks, function (e) {
                  r
                    ? e(t)
          ...
          (i.Credentials.addPromisesToClass = function (e) {
            (this.prototype.getPromise = i.util.promisifyMethod("get", e)),
              (this.prototype.refreshPromise = i.util.promisifyMethod(
                "refresh",
                e
              ));
          }),
          (i.Credentials.deletePromisesFromClass = function () {
            delete this.prototype.getPromise,
              delete this.prototype.refreshPromise;
          }),
          i.util.addPromises(i.Credentials);
      },
      {
        "./core": 39,
      },
    ...
    24: [
      function (e, t, r) {
        ...
        t.exports = function (e, t, r) {
          ...
          if (null == s || null == o) {
            var a = y();
            null == s && (s = d = [1 | a[0], a[1], a[2], a[3], a[4], a[5]]),
          ...
          if (
            ...
            (p < 0 || v < u) && void 0 === e.nsecs && (c = 0),
            1e4 <= c)
          )
            throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
          (v = u), (m = o);
          var l =
            (1e4 * (268435455 & (u += 122192928e5)) + (b = c)) % 4294967296;
          (i[n++] = (l >>> 24) & 255),
            (i[n++] = (l >>> 16) & 255),
            (i[n++] = (l >>> 8) & 255),
            (i[n++] = 255 & l);
        ...
        (function (n, i) {
          function a(e, t) {
            ...
            return (
              ...
              S(t) ? (r.showHidden = t) : t && N._extend(r, t),
          ...
          function y(t, r, n) {
            ...
            return (
              ...
              C(r) && (f = " " + RegExp.prototype.toString.call(r)),
                    ...
                    (c = d
                      ? (function (t, r, n, i, e) {
                          for (var s = [], o = 0, a = r.length; o < a; ++o)
                            I(r, String(o))
                              ? s.push(v(t, r, n, i, String(o), !0))
                              : s.push("");
                          return (
                            e.forEach(function (e) {
                              e.match(/^\d+$/) || s.push(v(t, r, n, i, e, !0));
                            }),
                            s
                          );
                        })(t, r, n, a, o)
                      : o.map(function (e) {
                          return v(t, r, n, a, e, d);
                        })),
                    t.seen.pop(),
                    (l = f),
                    (h = m),
          ...
          (N.format = function (e) {
            ...
            for (
              var n = arguments,
                i = n.length,
                s = String(e).replace(c, function (e) {
                  if ("%%" === e) return "%";
                  if (i <= r) return e;
                  switch (e) {
                    case "%s":
    ...
    8: [
      function (e, t, r) {
        ...
        (h.nextTick = function (e) {
          ...
          d.push(new u(e, t)), 1 !== d.length || m || s(a);
        }),
          ...
          function I(e, t) {
            ...
            for (var i in e)
              if (hasOwnProperty.call(e, i)) {
                if (!1 === I(e[i], t[i])) return !1;
                n[i] = !0;
              }
            for (var s in t)
              if (hasOwnProperty.call(t, s) && !0 !== n[s]) return !1;
            return !0;
          }
          function N(e) {
          ...
          r.prototype = {
            tokenize: function (e) {
              ...
              for (this._current = 0; this._current < e.length; )
                ...
                else if (void 0 !== y[e[this._current]])
                  s.push({
                    type: y[e[this._current]],
                    value: e[this._current],
                    start: this._current,
                  }),
                    this._current++;
                else if (u(e[this._current]))
                  (n = this._consumeNumber(e)), s.push(n);
                else if ("[" === e[this._current])
                  (n = this._consumeLBracket(e)), s.push(n);
                else if ('"' === e[this._current])
                  (t = this._current),
                ...
                } else if (void 0 !== g[e[this._current]])
                  s.push(this._consumeOperator(e));
            ...
            _consumeNumber: function (e) {
              var t = this._current;
              this._current++;
              for (var r = e.length; u(e[this._current]) && this._current < r; )
                this._current++;
              return {
                type: "Number",
            ...
            _consumeLiteral: function (e) {
              ...
              var s = p(e.slice(r, this._current));
              return (
                (s = s.replace("\\`", "`")),
                (t = this._looksLikeJSON(s)
                  ? JSON.parse(s)
                  : JSON.parse('"' + s + '"')),
                this._current++,
                t
          ...
          (o.prototype = {
            parse: function (e) {
              ...
              var r = this._lookaheadToken(0),
                n = new Error(
                  "Unexpected token type: " + r.type + ", value: " + r.value
                );
            ...
            expression: function (e) {
              ...
              this._advance();
              for (var r = this.nud(t), n = this._lookahead(0); e < b[n]; )
            ...
            nud: function (e) {
              ...
              switch (e.type) {
                ...
                case "Not":
                  return {
                    type: "NotExpression",
                    children: [(t = this.expression(b.Not))],
                  };
                case "Star":
                  return (
                    (t = null),
                      ...
                      children: [
                        ...
                        (t =
                          "Rbracket" === this._lookahead(0)
                            ...
                            : this._parseProjectionRHS(b.Star)),
                      ],
                    }
                  );
                case "Filter":
                ...
                case "Lbracket":
                  return "Number" === this._lookahead(0) ||
                    "Colon" === this._lookahead(0)
                    ...
                    : "Star" === this._lookahead(0) &&
                      "Rbracket" === this._lookahead(1)
                    ? (this._advance(),
                      this._advance(),
                      {
                        type: "Projection",
                        children: [
                          ...
                          (t = this._parseProjectionRHS(b.Star)),
                        ],
                      })
                ...
                case "Expref":
                  return {
                    ...
                    children: [(r = this.expression(b.Expref))],
                  };
                case "Lparen":
            ...
            led: function (e, t) {
              ...
              switch (e) {
                ...
                case "Pipe":
                  return {
                    type: "Pipe",
                    children: [t, (r = this.expression(b.Pipe))],
                  };
                case "Or":
                  return {
                    type: "OrExpression",
                    children: [t, (r = this.expression(b.Or))],
                  };
                case "And":
                  return {
                    type: "AndExpression",
                    children: [t, (r = this.expression(b.And))],
                  };
                case "Lparen":
                  for (
                    var i, s = t.name, o = [];
                    "Rparen" !== this._lookahead(0);
                      ...
                      children: [
                        ...
                        (r =
                          "Flatten" === this._lookahead(0)
                            ...
                            : this._parseProjectionRHS(b.Filter)),
                        a,
                      ],
                    }
                  );
                case "Flatten":
                  return {
                    ...
                    children: [
                      ...
                      this._parseProjectionRHS(b.Flatten),
                    ],
                  };
                case "EQ":
                case "NE":
                ...
                case "Lbracket":
                  ...
                  return "Number" === u.type || "Colon" === u.type
                    ? ((r = this._parseIndexExpression()),
                      this._projectIfSlice(t, r))
                    : (this._match("Star"),
                      this._match("Rbracket"),
                      {
                        type: "Projection",
                        children: [t, (r = this._parseProjectionRHS(b.Star))],
                      });
                default:
            ...
            _projectIfSlice: function (e, t) {
              ...
              return "Slice" === t.type
                ? {
                    type: "Projection",
                    children: [r, this._parseProjectionRHS(b.Star)],
                  }
                : r;
            },
            ...
            _parseComparator: function (e, t) {
              return {
                type: "Comparator",
                name: t,
                children: [e, this.expression(b[t])],
              };
            },
            ...
            _parseMultiselectHash: function () {
              for (
                var e,
                  ...
                  r,
                  n = [],
                  i = ["UnquotedIdentifier", "QuotedIdentifier"];
                ;
            ...
            (a.prototype = {
              ...
              visit: function (e, t) {
                ...
                switch (e.type) {
                  ...
                  case "Subexpression":
                    for (
                      i = this.visit(e.children[0], t), p = 1;
                      p < e.children.length;
                      p++
                    )
                      if (null === (i = this.visit(e.children[1], i)))
                        return null;
                    return i;
                  case "IndexExpression":
                    return (
                      (u = this.visit(e.children[0], t)),
                      this.visit(e.children[1], u)
                    );
                  case "Index":
                    if (!x(t)) return null;
                    var l = e.value;
                  ...
                  case "Slice":
                    ...
                    var h = e.children.slice(0),
                      ...
                      y = f[2];
                    if (((i = []), 0 < y))
                      for (p = d; p < m; p += y) i.push(t[p]);
                    else for (p = d; m < p; p += y) i.push(t[p]);
                    return i;
                  case "Projection":
                    var g = this.visit(e.children[0], t);
                    if (!x(g)) return null;
                    for (c = [], p = 0; p < g.length; p++)
                      null !== (n = this.visit(e.children[1], g[p])) &&
                        c.push(n);
                    return c;
                  case "ValueProjection":
                    if (!T((g = this.visit(e.children[0], t)))) return null;
                    c = [];
                    var v = (function (e) {
                      for (
                    ...
                    for (p = 0; p < v.length; p++)
                      null !== (n = this.visit(e.children[1], v[p])) &&
                        c.push(n);
                    return c;
                  case "FilterProjection":
                    if (!x((g = this.visit(e.children[0], t)))) return null;
                    var b = [],
                      S = [];
                    for (p = 0; p < g.length; p++)
                      N((r = this.visit(e.children[2], g[p]))) || b.push(g[p]);
                    for (var w = 0; w < b.length; w++)
                      null !== (n = this.visit(e.children[1], b[w])) &&
                        S.push(n);
                    return S;
                  case "Comparator":
                    switch (
                      ((s = this.visit(e.children[0], t)),
                      (o = this.visit(e.children[1], t)),
                      e.name)
                    ) {
                      case "EQ":
                        i = I(s, o);
                    ...
                    return i;
                  case "Flatten":
                    var R = this.visit(e.children[0], t);
                    if (!x(R)) return null;
                    var E = [];
                    for (p = 0; p < R.length; p++)
                      x((n = R[p])) ? E.push.apply(E, n) : E.push(n);
                    return E;
                  case "Identity":
                    return t;
                  case "MultiSelectList":
                    if (null === t) return null;
                    for (c = [], p = 0; p < e.children.length; p++)
                  ...
                  case "MultiSelectHash":
                    ...
                    var A;
                    for (c = {}, p = 0; p < e.children.length; p++)
                      c[(A = e.children[p]).name] = this.visit(A.value, t);
                    return c;
                  case "OrExpression":
                    return (
                      N((r = this.visit(e.children[0], t))) &&
                        (r = this.visit(e.children[1], t)),
                      r
                    );
                  case "AndExpression":
                    return !0 === N((s = this.visit(e.children[0], t)))
                      ? s
                      : this.visit(e.children[1], t);
                  case "NotExpression":
                    return N((s = this.visit(e.children[0], t)));
                  case "Literal":
                    return e.value;
                  case "Pipe":
                    return (
                  ...
                  case "ExpressionReference":
                    var _ = e.children[0];
                    return (_.jmespathType = "Expref"), _;
                  default:
              ...
              computeSliceParams: function (e, t) {
                ...
                return (
                  (r =
                    null === r ? (a ? e - 1 : 0) : this.capSliceRange(e, r, i)),
            ...
            (c.prototype = {
              callFunction: function (e, t) {
                ...
                return (
                  this._validateArgs(e, t, r._signature), r._func.call(this, t)
                );
              },
              ...
              _getTypeName: function (e) {
                switch (Object.prototype.toString.call(e)) {
                  ...
                  case "[object Null]":
                    return 7;
                  case "[object Object]":
                    return "Expref" === e.jmespathType ? n : t;
                }
              },
              ...
              _functionReverse: function (e) {
                if (this._getTypeName(e[0]) === h) {
                  for (var t = e[0], r = "", n = t.length - 1; 0 <= n; n--)
                    r += t[n];
                  return r;
                }
                var i = e[0].slice(0);
              ...
              _functionLength: function (e) {
                return T(e[0]) ? Object.keys(e[0]).length : e[0].length;
              },
              _functionMap: function (e) {
                for (
                  var t = [], r = this._interpreter, n = e[0], i = e[1], s = 0;
                  s < i.length;
                  s++
                )
                  t.push(r.visit(n, i[s]));
                return t;
              },
              ...
              _functionValues: function (e) {
                for (
                  var t = e[0], r = Object.keys(t), n = [], i = 0;
                  i < r.length;
                  i++
                )
                  n.push(t[r[i]]);
              ...
              _functionToArray: function (e) {
                return this._getTypeName(e[0]) === f ? e[0] : [e[0]];
              },
              _functionToString: function (e) {
                return this._getTypeName(e[0]) === h
                  ? e[0]
                  : JSON.stringify(e[0]);
              },
              ...
              _functionSortBy: function (e) {
                ...
                var i = this._interpreter,
                  s = e[1],
                  o = this._getTypeName(i.visit(s, t[0]));
                if ([l, h].indexOf(o) < 0) throw new Error("TypeError");
                for (var a = this, r = [], n = 0; n < t.length; n++)
                  r.push([n, t[n]]);
                r.sort(function (e, t) {
                  var r = i.visit(s, e[1]),
                    n = i.visit(s, t[1]);
                  if (a._getTypeName(r) !== o)
                    throw new Error(
                      "TypeError: expected " +
                        o +
                        ", received " +
                  ...
                  return n < r ? 1 : r < n ? -1 : e[0] - t[0];
                });
                for (var u = 0; u < r.length; u++) t[u] = r[u][1];
                return t;
              },
              _functionMaxBy: function (e) {
                for (
                  var t,
                    ...
                    n = e[1],
                    i = e[0],
                    s = this.createKeyFunction(n, [l, h]),
                    o = -1 / 0,
                    a = 0;
                  a < i.length;
                  a++
              ...
              createKeyFunction: function (n, i) {
                ...
                return function (e) {
                  var t = o.visit(n, e);
                  if (i.indexOf(s._getTypeName(t)) < 0) {
                    var r =
            ...
            (e.tokenize = function (e) {
              return new r().tokenize(e);
            }),
            (e.compile = function (e) {
              return new o().parse(e);
            }),
  ...
  (_xamzrequire = (function s(o, a, u) {
    function c(t, e) {
      if (!a[t]) {
        if (!o[t]) {
          var r = "function" == typeof _xamzrequire && _xamzrequire;
          if (!e && r) return r(t, !0);
          if (p) return p(t, !0);
          var n = new Error("Cannot find module '" + t + "'");
          throw ((n.code = "MODULE_NOT_FOUND"), n);
    ...
    for (
      var p = "function" == typeof _xamzrequire && _xamzrequire, e = 0;
      e < u.length;
      e++
    )
      c(u[e]);
  ...
  })(
    {
      ...
      35: [
        function (n, i, e) {
          (function (e) {
            var t = n("./util");
            (t.crypto.lib = n("./browserCryptoLib")),
              (t.Buffer = n("buffer/").Buffer),
              (t.url = n("url/")),
              (t.querystring = n("querystring/")),
              (t.realClock = n("./realclock/browserClock")),
              (t.environment = "js"),
              (t.createEventStream = n(
            ...
            if (
              ((i.exports = r),
              n("./credentials"),
              n("./credentials/credential_provider_chain"),
              n("./credentials/temporary_credentials"),
              n("./credentials/chainable_temporary_credentials"),
              n("./credentials/web_identity_credentials"),
              n("./credentials/cognito_identity_credentials"),
              n("./credentials/saml_credentials"),
              (r.XML.Parser = n("./xml/browser_parser")),
              n("./http/xhr"),
              void 0 === e)
            )
              e = {
      ...
      119: [
        function (e, t, r) {
                ...
                return (function (e, t) {
                  for (
                    var r = {},
                      ...
                      s = t.flattened ? t.name : "entry",
                      o = e.firstElementChild;
                    o;

                  ) {
                    if (o.nodeName === s) {
                      var a = c(o, n).textContent,
                        u = c(o, i);
                      r[a] = p(u, t.value);
                    }
              ...
              case "list":
                return (function (e, t) {
                  for (
                    ...
                    i.nodeName === n && r.push(p(i, t.member)),
          ...
          function i(i, s) {
            ...
            return (
              null === i ||
                u.each(s.members, function (e, t) {
                  if (t.isXmlAttribute) {
                    if (
                      Object.prototype.hasOwnProperty.call(i.attributes, t.name)
                    ) {
                      var r = i.attributes[t.name].value;
                      o[e] = p(
                        {
                          textContent: r,
                        },
                    ...
                    var n = t.flattened ? i : c(i, t.name);
                    n
                      ? (o[e] = p(n, t))
                      : t.flattened ||
                        "list" !== t.type ||
                        s.api.xmlNoDefaultLists ||
                        (o[e] = t.defaultValue);
                  }
                }),
              o
          ...
          (n.prototype.parse = function (e, t) {
            ...
            try {
              if (window.DOMParser) {
                try {
                  ...
                  throw u.error(new Error("Parse error in document"), {
                    originalError: e,
                    code: "XMLParserError",
                    retryable: !0,
                  });
                ...
                if (null === r.documentElement)
                  throw u.error(new Error("Cannot parse empty document."), {
                    code: "XMLParserError",
                    retryable: !0,
                  });
                ...
                if (
                  i &&
                  (i.parentNode === r ||
                    "body" === i.parentNode.nodeName ||
                    i.parentNode.parentNode === r ||
                    "body" === i.parentNode.parentNode.nodeName)
                ) {
                  var s = i.getElementsByTagName("div")[0] || i;
                  throw u.error(
                    new Error(s.textContent || "Parser error in document"),
                    {
                      code: "XMLParserError",
                      retryable: !0,
                    }
                ...
                if (
                  (((r = new window.ActiveXObject("Microsoft.XMLDOM")).async =
                    !1),
                  !r.loadXML(e))
                )
                  throw u.error(new Error("Parse error in document"), {
            ...
            if (r && r.documentElement && !n) {
              var o = p(r.documentElement, t),
                a = c(r.documentElement, "ResponseMetadata");
              return a && (o.ResponseMetadata = p(a, {})), o;
            }
            if (n)
              throw u.error(n || new Error(), {
                code: "XMLParserError",
                retryable: !0,
              });
            return {};
      ...
      62: [
        function (e, t, r) {
          ...
          e("../http"),
            (p.XHRClient = p.util.inherit({
              handleRequest: function (e, t, r, n) {
                var i = this,
                  s = e.endpoint,
                  o = new l(),
                  a = s.protocol + "//" + s.hostname;
                80 !== s.port && 443 !== s.port && (a += ":" + s.port),
                  (a += e.path);
                var u = new XMLHttpRequest(),
                  c = !1;
                (e.stream = u).addEventListener(
                  "readystatechange",
                  function () {
                    try {
                      if (0 === u.status) return;
                    } catch (e) {
                      return;
                    }
                    this.readyState >= this.HEADERS_RECEIVED &&
                      !c &&
                      ((o.statusCode = u.status),
                      (o.headers = i.parseHeaders(u.getAllResponseHeaders())),
                      o.emit("headers", o.statusCode, o.headers, u.statusText),
                      (c = !0)),
                      this.readyState === this.DONE && i.finishRequest(u, o);
                  },
                  !1
                ),
                  u.upload.addEventListener("progress", function (e) {
                    o.emit("sendProgress", e);
                  }),
                  u.addEventListener(
                    "progress",
                    function (e) {
                      o.emit("receiveProgress", e);
                    },
                    !1
                  ),
                  u.addEventListener(
                    ...
                    function () {
                      n(
                        p.util.error(new Error("Timeout"), {
                          code: "TimeoutError",
                        })
                      );
                    },
                  ...
                  u.addEventListener(
                    ...
                    function () {
                      n(
                        p.util.error(new Error("Network Failure"), {
                  ...
                  u.addEventListener(
                    ...
                    function () {
                      n(
                        p.util.error(new Error("Request aborted"), {
                          code: "RequestAbortedError",
                        })
                      );
                    },
                  ...
                  r(o),
                  u.open(e.method, a, !1 !== t.xhrAsync),
                  p.util.each(e.headers, function (e, t) {
                    "Content-Length" !== e &&
                      "User-Agent" !== e &&
                      "Host" !== e &&
                      u.setRequestHeader(e, t);
                  }),
                  t.timeout && !1 !== t.xhrAsync && (u.timeout = t.timeout),
                  t.xhrWithCredentials && (u.withCredentials = !0);
                try {
                  u.responseType = "arraybuffer";
                } catch (e) {}
                try {
                  e.body ? u.send(e.body) : u.send();
                } catch (t) {
                  if (!e.body || "object" != typeof e.body.buffer) throw t;
                  u.send(e.body.buffer);
                }
                return o;
              },
              parseHeaders: function (e) {
                ...
                return (
                  p.util.arrayEach(e.split(/\r?\n/), function (e) {
                    var t = e.split(":", 1)[0],
                      r = e.substring(t.length + 2);
                    0 < t.length && (n[t.toLowerCase()] = r);
                  }),
                  n
                );
              },
              finishRequest: function (e, t) {
                ...
                if ("arraybuffer" === e.responseType && e.response) {
                  var n = e.response;
                  r = new p.util.Buffer(n.byteLength);
                  for (var i = new Uint8Array(n), s = 0; s < r.length; ++s)
                    r[s] = i[s];
                }
                try {
                  r ||
                    "string" != typeof e.responseText ||
                    (r = new p.util.Buffer(e.responseText));
                } catch (e) {}
                r && t.emit("data", r), t.emit("end");
              },
            })),
            (p.HttpClient.prototype = p.XHRClient.prototype),
            (p.HttpClient.streamsApiVersion = 1);
        },
        {
          "../core": 39,
          "../http": 61,
        ...
        function (e, t, r) {
          ...
          t.exports = {
            createEventStream: function (e, t, r) {
              for (var n = o(e), i = [], s = 0; s < n.length; s++)
                i.push(a(t, n[s], r));
              return i;
            },
          };
          ...
          t.exports = {
            parseEvent: function (e, t, r) {
              var n,
                ...
                o,
                a = v(t),
                u = a.headers[":message-type"];
              if (u) {
                if ("error" === u.value)
                  throw (
                    ((i = (n = a).headers[":error-code"]),
                    (s = n.headers[":error-message"]),
                    ((o = new Error(s.value || s)).code = o.name =
                      i.value || i),
                    o)
                  );
                if ("event" !== u.value) return;
              }
              var c = a.headers[":event-type"],
                p = r.members[c.value];
              if (p) {
                var l = {},
                  h = p.eventPayloadMemberName;
                if (h) {
                  var f = p.members[h];
                  "binary" === f.type
                    ? (l[h] = a.body)
                    : (l[h] = e.parse(a.body.toString(), f));
                }
                for (
                  var d = p.eventHeaderMemberNames, m = 0;
                  m < d.length;
                  m++
                ) {
                  var y = d[m];
                  a.headers[y] &&
                    (l[y] = p.members[y].toType(a.headers[y].value));
                }
                var g = {};
                return (g[c.value] = l), g;
              }
            },
          };
        },
      ...
      58: [
        function (e, t, r) {
          var u = e("./int64").Int64,
            n = e("./split-message").splitMessage,
            c = "boolean",
            p = "byte",
            l = "short",
            h = "integer",
                  ...
                  for (var t = {}, r = 0; r < e.length; ) {
                    ...
                    switch (((r += n), e.readUInt8(r++))) {
                      ...
                      case 8:
                        (t[i] = {
                          type: y,
                          value: new Date(new u(e.slice(r, r + 8)).valueOf()),
                        }),
                          (r += 8);
                        break;
                      case 9:
                        var a = e.slice(r, r + 16).toString("hex");
                        (r += 16),
                          (t[i] = {
                            type: g,
                            value:
        ...
        function (e, t, r) {
          ...
          t.exports = {
            splitMessage: function (e) {
              if ((i.Buffer.isBuffer(e) || (e = s(e)), e.length < 16))
                throw new Error(
              ...
              if (t !== i.crypto.crc32(e.slice(0, 8)))
                throw new Error(
              ...
              if (r !== i.crypto.crc32(e.slice(0, e.length - 4)))
                throw new Error(
                  "The message checksum did not match the expected value of " +
                    r
                );
              var n = 12 + e.readUInt32BE(4);
              return {
                headers: e.slice(12, n),
                body: e.slice(n, e.length - 4),
              };
            },
          };
        },
      ...
      56: [
        function (e, t, r) {
          ...
          (i.fromNumber = function (e) {
            if (0x8000000000000000 < e || e < -0x8000000000000000)
              throw new Error(
                e +
                  " is too large (or, if negative, too small) to represent as an Int64"
              );
            for (
              var t = new Uint8Array(8), r = 7, n = Math.abs(Math.round(e));
              -1 < r && 0 < n;
              r--, n /= 256
            )
              t[r] = n;
            return e < 0 && s(t), new i(t);
          }),
        ...
        function (e, t, r) {
          ...
          n.WebIdentityCredentials = n.util.inherit(n.Credentials, {
            ...
            load: function (r) {
              var n = this;
              n.createClients(),
                n.service.assumeRoleWithWebIdentity(function (e, t) {
                  (n.data = null),
                    e || ((n.data = t), n.service.credentialsFrom(t, n)),
                    r(e);
                });
            },
        ...
        function (e, t, r) {
          ...
          n.TemporaryCredentials = n.util.inherit(n.Credentials, {
            ...
            load: function (r) {
              var n = this;
              n.createClients(),
                n.masterCredentials.get(function () {
                  (n.service.config.credentials = n.masterCredentials),
                    (n.params.RoleArn
                      ? n.service.assumeRole
                      : n.service.getSessionToken
                    ).call(n.service, function (e, t) {
                      e || n.service.credentialsFrom(t, n), r(e);
                    });
                });
            },
            loadMasterCredentials: function (e) {
              ...
              "function" != typeof this.masterCredentials.get &&
                (this.masterCredentials = new n.Credentials(
                  this.masterCredentials
                ));
            },
            createClients: function () {
        ...
        function (e, t, r) {
          ...
          n.SAMLCredentials = n.util.inherit(n.Credentials, {
            ...
            load: function (r) {
              var n = this;
              n.createClients(),
                n.service.assumeRoleWithSAML(function (e, t) {
                  e || n.service.credentialsFrom(t, n), r(e);
                });
            },
            createClients: function () {
          ...
          n.CognitoIdentityCredentials = n.util.inherit(n.Credentials, {
            ...
            load: function (t) {
              ...
              r.createClients(),
                ...
                r.getId(function (e) {
                  e
                    ? (r.clearIdOnNotAuthorized(e), t(e))
                    : r.params.RoleArn
                    ? r.getCredentialsFromSTS(t)
                    : r.getCredentialsForIdentity(t);
                });
            },
            ...
            getId: function (r) {
              var n = this;
              if ("string" == typeof n.params.IdentityId)
                return r(null, n.params.IdentityId);
              n.cognito.getId(function (e, t) {
                !e && t.IdentityId
                  ? ((n.params.IdentityId = t.IdentityId),
                    r(null, t.IdentityId))
                  : r(e);
              });
            },
            ...
            getCredentialsForIdentity: function (r) {
              var n = this;
              n.cognito.getCredentialsForIdentity(function (e, t) {
                e
                  ? n.clearIdOnNotAuthorized(e)
                  : (n.cacheId(t), (n.data = t), n.loadCredentials(n.data, n)),
                  r(e);
              });
            },
            getCredentialsFromSTS: function (r) {
              var n = this;
              n.cognito.getOpenIdToken(function (e, t) {
                e
                  ? (n.clearIdOnNotAuthorized(e), r(e))
                  : (n.cacheId(t),
                    (n.params.WebIdentityToken = t.Token),
                    n.webIdentityCredentials.refresh(function (e) {
                      e ||
                        ((n.data = n.webIdentityCredentials.data),
                        n.sts.credentialsFrom(n.data, n)),
                        r(e);
                    }));
              });
            },
            ...
            createClients: function () {
              ...
              if (
                ((this.webIdentityCredentials =
                  this.webIdentityCredentials ||
                  new n.WebIdentityCredentials(this.params, e)),
                !this.cognito)
              ) {
      ...
      41: [
        function (e, t, r) {
          var s = e("../core");
          s.ChainableTemporaryCredentials = s.util.inherit(s.Credentials, {
            constructor: function (e) {
              s.Credentials.call(this),
                (e = e || {}),
                (this.errorCode =
                  "ChainableTemporaryCredentialsProviderFailure"),
                (this.expired = !0),
                (this.tokenCodeFn = null);
              var t = s.util.copy(e.params) || {};
              if (
                (t.RoleArn &&
                  (t.RoleSessionName =
                    t.RoleSessionName || "temporary-credentials"),
                t.SerialNumber)
              ) {
                if (!e.tokenCodeFn || "function" != typeof e.tokenCodeFn)
                  throw new s.util.error(
                    new Error(
              ...
              var r = s.util.merge(
                {
                  params: t,
                  credentials: e.masterCredentials || s.config.credentials,
                },
                e.stsConfig || {}
              );
              this.service = new s.STS(r);
            },
            refresh: function (e) {
              this.coalesceRefresh(e || s.util.fn.callback);
            },
            load: function (n) {
              var i = this,
                s = i.service.config.params.RoleArn
                  ? "assumeRole"
                  : "getSessionToken";
              this.getTokenCode(function (e, t) {
                ...
                e
                  ? n(e)
                  : (t && (r.TokenCode = t),
                    i.service[s](r, function (e, t) {
                      e || i.service.credentialsFrom(t, i), n(e);
                    }));
              });
            },
            getTokenCode: function (n) {
              var i = this;
              this.tokenCodeFn
                ? this.tokenCodeFn(
                    this.service.config.params.SerialNumber,
                    function (e, t) {
                      if (e) {
                        var r = e;
                        return (
                          ...
                          void n(
                            s.util.error(
                              new Error("Error fetching MFA token: " + r),
                              {
                                code: i.errorCode,
                              }
                            )
        ...
        function (e, t, r) {
          ...
          t.exports = {
            createHash: function (e) {
              ...
              throw new Error(
                "Hash algorithm " + e + " is not supported in the browser SDK"
              );
            },
            createHmac: function (e, t) {
              ...
              throw new Error(
                "HMAC algorithm " + e + " is not supported in the browser SDK"
              );
            },
            createSign: function () {
        ...
        function (e, t, r) {
          ...
          ((t.exports = n).BLOCK_SIZE = 64),
            (n.prototype.update = function (e) {
              ...
              if (((this.bytesHashed += r), 8 * this.bytesHashed > s))
            ...
            (n.prototype.digest = function (e) {
              if (!this.finished) {
                var t = 8 * this.bytesHashed,
                  ...
                  n = this.bufferLength;
                if ((r.setUint8(this.bufferLength++, 128), 56 <= n % 64)) {
                  for (var i = this.bufferLength; i < 64; i++) r.setUint8(i, 0);
                  this.hashBuffer(), (this.bufferLength = 0);
                }
                for (i = this.bufferLength; i < 56; i++) r.setUint8(i, 0);
              ...
              var s = new o(32);
              for (i = 0; i < 8; i++)
                (s[4 * i] = (this.state[i] >>> 24) & 255),
                  (s[4 * i + 1] = (this.state[i] >>> 16) & 255),
                  (s[4 * i + 2] = (this.state[i] >>> 8) & 255),
                  (s[4 * i + 3] = (this.state[i] >>> 0) & 255);
        ...
        function (e, t, r) {
          ...
          new Uint32Array([1518500249, 1859775393, -1894007588, -899497514]),
            ...
            (n.prototype.update = function (e) {
              ...
              var t = (e = s.convertToBuffer(e)).length;
            ...
            (n.prototype.write = function (e) {
              (this.block[this.offset] |= (255 & e) << this.shift),
                this.shift
                  ? (this.shift -= 8)
                  : (this.offset++, (this.shift = 24)),
                16 === this.offset && this.processBlock();
            }),
            (n.prototype.digest = function (e) {
              this.write(128),
                (14 < this.offset || (14 === this.offset && this.shift < 24)) &&
                  this.processBlock(),
                (this.offset = 14),
                (this.shift = 24),
                this.write(0),
                this.write(0),
                this.write(
                  0xffffffffff < this.totalLength
                    ? this.totalLength / 1099511627776
                    : 0
                ),
                this.write(
                  4294967295 < this.totalLength
                    ? this.totalLength / 4294967296
                    : 0
                );
            ...
            (n.prototype.processBlock = function () {
              ...
              for (e = 0; e < 80; e++) {
                n =
                  e < 20
                    ? ((r = a ^ (s & (o ^ a))), 1518500249)
                    : e < 40
                    ? ((r = s ^ o ^ a), 1859775393)
                    : e < 60
                    ? ((r = (s & o) | (a & (s | o))), 2400959708)
                    : ((r = s ^ o ^ a), 3395469782);
                var c =
                  ((i << 5) | (i >>> 27)) + r + u + n + (0 | this.block[e]);
        ...
        function (e, t, r) {
          ...
          ((t.exports = n).BLOCK_SIZE = 64),
            (n.prototype.update = function (e) {
              ...
              var t = i.convertToBuffer(e),
                r = 0,
                n = t.byteLength;
              for (this.bytesHashed += n; 0 < n; )
            ...
            (n.prototype.digest = function (e) {
              if (!this.finished) {
                ...
                if ((t.setUint8(this.bufferLength++, 128), 56 <= r % 64)) {
                  for (var i = this.bufferLength; i < 64; i++) t.setUint8(i, 0);
                  this.hashBuffer(), (this.bufferLength = 0);
                }
                for (i = this.bufferLength; i < 56; i++) t.setUint8(i, 0);
                t.setUint32(56, n >>> 0, !0),
                  t.setUint32(60, Math.floor(n / 4294967296), !0),
                  this.hashBuffer(),
                  (this.finished = !0);
              }
              var s = new DataView(new ArrayBuffer(16));
              for (i = 0; i < 4; i++) s.setUint32(4 * i, this.state[i], !0);
              var o = new l(s.buffer, s.byteOffset, s.byteLength);
            ...
            (n.prototype.hashBuffer = function () {
              ...
              (n = p(
                (n = p(
                  (n = p(
                    ...
                    (i = p(
                      ...
                      (s = p(
                        s,
                        (r = p(r, n, i, s, e.getUint32(48, !0), 6, 1700485571)),
                        n,
                        i,
                        e.getUint32(12, !0),
                        10,
                  ...
                  (i = p(
                    ...
                    (s = p(
                      s,
                      (r = p(r, n, i, s, e.getUint32(32, !0), 6, 1873313359)),
                      n,
                      i,
                      e.getUint32(60, !0),
                      10,
                ...
                (i = p(
                  ...
                  (s = p(
                    s,
                    (r = p(r, n, i, s, e.getUint32(16, !0), 6, 4149444226)),
                    n,
                    i,
                    e.getUint32(44, !0),
                    10,
      ...
      31: [
        function (e, t, r) {
          ...
          ((t.exports = n).prototype.update = function (e) {
        ...
        function (e, t, r) {
          ...
          "undefined" != typeof ArrayBuffer &&
            ...
            (ArrayBuffer.isView = function (e) {
              return -1 < i.indexOf(Object.prototype.toString.call(e));
            });
          var i = [
            "[object Int8Array]",
            "[object Uint8Array]",
      ...
      17: [
        function (e, t, r) {
          ...
          function n(e, t, r) {
            if (e && a(e) && e instanceof v) return e;
            var n = new v();
          ...
          (r.parse = n),
            ...
            (r.format = function (e) {
              return (
                k(e) && (e = n(e)),
                e instanceof v ? e.format() : v.prototype.format.call(e)
              );
            }),
            (r.Url = v);
          var P = /^([a-z0-9.+-]+:)/i,
            ...
            H = e("querystring");
          (v.prototype.parse = function (e, t, r) {
            if (!k(e))
              throw new TypeError(
            ...
            if (r || i || n.match(/^\/\/[^@\/]+@[^@\/]+/)) {
              var o = "//" === n.substr(0, 2);
              !o || (i && B[i]) || ((n = n.substr(2)), (this.slashes = !0));
            }
            if (!B[i] && (o || (i && !F[i]))) {
              for (var a = -1, u = 0; u < U.length; u++) {
                -1 !== (l = n.indexOf(U[u])) && (-1 === a || l < a) && (a = l);
              }
              var c, p;
              -1 !==
              ...
              if (!h)
                for (
                  var f = this.hostname.split(/\./), d = ((u = 0), f.length);
                  u < d;
                  u++
                ) {
                  var m = f[u];
                  if (m && !m.match(D)) {
                    for (var y = "", g = 0, v = m.length; g < v; g++)
                      127 < m.charCodeAt(g) ? (y += "x") : (y += m[g]);
                    if (!y.match(D)) {
                      var b = f.slice(0, u),
                        S = f.slice(u + 1),
                        w = m.match(M);
                      w && (b.push(w[1]), S.unshift(w[2])),
                        S.length && (n = "/" + S.join(".") + n),
              ...
              if (
                ...
                for (u = 0; u < R.length; ++u) {
                  var A = R[u];
                  E.push(A.match(/[^A-Za-z0-9_-]/) ? "xn--" + q.encode(A) : A);
                }
            ...
            if (!j[s])
              for (u = 0, d = L.length; u < d; u++) {
                var x = L[u],
                  T = encodeURIComponent(x);
                T === x && (T = escape(x)), (n = n.split(x).join(T));
              }
            var I = n.indexOf("#");
            -1 !== I && ((this.hash = n.substr(I)), (n = n.slice(0, I)));
            var N = n.indexOf("?");
            if (
              (-1 !== N
                ? ((this.search = n.substr(N)),
                  (this.query = n.substr(N + 1)),
                  t && (this.query = H.parse(this.query)),
                  (n = n.slice(0, N)))
            ...
            (v.prototype.format = function () {
              ...
              this.host
                ...
                this.query &&
                  ...
                  (s = H.stringify(this.query));
              var o = this.search || (s && "?" + s) || "";
              return (
                t && ":" !== t.substr(-1) && (t += ":"),
                this.slashes || ((!t || F[t]) && !1 !== i)
                  ? ((i = "//" + (i || "")),
                    r && "/" !== r.charAt(0) && (r = "/" + r))
                  : i || (i = ""),
                n && "#" !== n.charAt(0) && (n = "#" + n),
            ...
            (v.prototype.resolveObject = function (t) {
              if (k(t)) {
                var e = new v();
                e.parse(t, !1, !0), (t = e);
              }
                ...
                if (l)
                  (r.hostname = r.host = p.shift()),
                    (y =
                      ...
                      r.host.split("@")) &&
                      ((r.auth = y.shift()), (r.host = r.hostname = y.shift()));
                return (
                  (r.search = t.search),
                  (r.query = t.query),
                  (b(r.pathname) && b(r.search)) ||
                    (r.path =
              ...
              for (
                ...
                "." == (h = p[m])
                  ...
                  ? (p.splice(m, 1), d++)
                  : d && (p.splice(m, 1), d--);
              if (!u && !c) for (; d--; d) p.unshift("..");
              !u ||
                "" === p[0] ||
                (p[0] && "/" === p[0].charAt(0)) ||
                p.unshift(""),
                f && "/" !== p.join("/").substr(-1) && p.push("");
              var y,
                g = "" === p[0] || (p[0] && "/" === p[0].charAt(0));
              l &&
                ((r.hostname = r.host = g ? "" : p.length ? p.shift() : ""),
                (y =
                  !!(r.host && 0 < r.host.indexOf("@")) && r.host.split("@")) &&
                  ((r.auth = y.shift()), (r.host = r.hostname = y.shift())));
              return (
                (u = u || (r.host && p.length)) && !g && p.unshift(""),
                p.length
                  ? (r.pathname = p.join("/"))
          ...
          t.exports = function (r, n, i, e) {
            return (
              ...
              "object" == typeof r
                ? Object.keys(r)
                    .map(function (e) {
                      var t = encodeURIComponent(s(e)) + i;
                    ...
                    .join(n)
                : e
                ? encodeURIComponent(s(e)) + i + encodeURIComponent(s(r))
                : ""
            );
          };
        },
              ...
              "object" == typeof r
                ? s(u(r), function (e) {
                    ...
                    return a(r[e])
                      ...
                      : t + encodeURIComponent(o(r[e]));
                  }).join(n)
                : e
                ? encodeURIComponent(o(e)) + i + encodeURIComponent(o(r))
                : ""
            );
          };
          var a =
            ...
            !(function (e) {
              ...
              function t(e, t) {
                ...
                return (
                  ...
                  n + i((e = e.replace(d, ".")).split("."), t).join(".")
                );
              }
              function v(e) {
                for (var t, r, n = [], i = 0, s = e.length; i < s; )
                  55296 <= (t = e.charCodeAt(i++)) && t <= 56319 && i < s
              ...
              function w(e, t, r) {
                var n = 0;
                for (
                  e = r ? I(e / l) : e >> 1, e += I(e / t);
                  (y * C) >> 1 < e;
                  n += E
                )
                  e = I(e / y);
                return I(n + ((y + 1) * e) / (e + p));
              }
              function r(e) {
                var t,
                  r,
                  ...
                  m = x,
                  y = _;
                for ((r = e.lastIndexOf(T)) < 0 && (r = 0), n = 0; n < r; ++n)
                  ...
                  for (
                    ...
                    f <= i && g("invalid-input"),
                      ...
                      (E <=
                        ...
                        g("overflow"),
                      (d += u * o),
                      !(u < (c = a <= y ? A : y + C <= a ? C : a - y));
                    a += E
                  )
                    o > I(R / (p = E - c)) && g("overflow"), (o *= p);
                  (y = w(d - s, (t = h.length + 1), 0 == s)),
                    I(d / t) > R - m && g("overflow"),
                    (m += I(d / t)),
                    (d %= t),
                    h.splice(d++, 0, m);
                }
              ...
              function n(e) {
                var t,
                  ...
                  m,
                  y = [];
                for (h = (e = v(e)).length, t = x, s = _, o = r = 0; o < h; ++o)
                  (l = e[o]) < 128 && y.push(N(l));
                for (n = i = y.length, i && y.push(T); n < h; ) {
                  for (a = R, o = 0; o < h; ++o)
                    (l = e[o]) >= t && l < a && (a = l);
                  for (
                    a - t > I((R - r) / (f = n + 1)) && g("overflow"),
                      r += (a - t) * f,
                      t = a,
                      o = 0;
                    o < h;
                    ...
                    if (((l = e[o]) < t && ++r > R && g("overflow"), l == t)) {
                      for (
                        u = r, c = E;
                        !(u < (p = c <= s ? A : s + C <= c ? C : c - s));
                        c += E
                      )
                        (m = u - p),
                          (d = E - p),
                          y.push(N(S(p + (m % d), 0))),
                          (u = I(m / d));
                      y.push(N(S(u, 0))), (s = w(r, f, n == i)), (r = 0), ++n;
                    }
                  ++r, ++t;
                }
                return y.join("");
              }
              var s = "object" == typeof P && P && !P.nodeType && P,
                o = "object" == typeof q && q && !q.nodeType && q,
                a = "object" == typeof k && k;
              ...
              if (
                ...
                if (q.exports == s) o.exports = u;
                else for (c in u) u.hasOwnProperty(c) && (s[c] = u[c]);
              else e.punycode = u;
            })(this);
          }).call(
            this,
        ...
        function (e, t, r) {
          ...
          (((t.exports = n).EventEmitter = n).prototype._events = void 0),
            ...
            (n.prototype.emit = function (e) {
              ...
              if (p((r = this._events[e]))) return !1;
              if (u(r))
      ...
      3: [
        function (t, e, U) {
          (function (e, l) {
              ...
              return "undefined" != typeof ArrayBuffer &&
                ...
                : (function (e, t) {
                    if (l.isBuffer(t)) {
                      var r = 0 | o(t.length);
                      return (
                        0 === (e = a(e, r)).length || t.copy(e, 0, 0, r), e
                      );
                    }
                    if (t) {
                      if (
                        ...
                        return "number" != typeof t.length ||
                          ...
                          ? a(e, 0)
                          : s(e, t);
                      if ("Buffer" === t.type && P(t.data)) return s(e, t.data);
                    }
                    var n;
                    throw new TypeError(
            ...
            function i(e, t) {
              if (
                (u(t), (e = a(e, t < 0 ? 0 : 0 | o(t))), !l.TYPED_ARRAY_SUPPORT)
              )
            ...
            function h(e, t, r, n, i) {
              ...
              if (("string" == typeof t && (t = l.from(t, n)), l.isBuffer(t)))
                return 0 === t.length ? -1 : f(e, t, r, n, i);
              if ("number" == typeof t)
                return (
                  (t &= 255),
                  l.TYPED_ARRAY_SUPPORT &&
            ...
            function f(e, t, r, n, i) {
              ...
              if (i) {
                var p = -1;
                for (o = r; o < u; o++)
                  if (s(e, o) === s(t, -1 === p ? 0 : o - p)) {
                    if ((-1 === p && (p = o), o - p + 1 === c)) return p * a;
                  } else -1 !== p && (o -= o - p), (p = -1);
              } else
                for (u < r + c && (r = u - c), o = r; 0 <= o; o--) {
            ...
            function b(e, t, r) {
              ...
              for (var s = "", o = t; o < r; ++o)
                s += (n = e[o]) < 16 ? "0" + n.toString(16) : n.toString(16);
              return s;
            }
            function S(e, t, r) {
            ...
            function _(e, t, r, n, i) {
              return i || C(e, 0, r, 4), q.write(e, t, r, n, 23, 4), r + 4;
            }
            function x(e, t, r, n, i) {
              return i || C(e, 0, r, 8), q.write(e, t, r, n, 52, 8), r + 8;
            }
            function T(e, t) {
              t = t || 1 / 0;
                ...
                for (var d = !1; ; )
                  switch (n) {
                    ...
                    case "binary":
                      return y(this, e, t, r);
                    case "base64":
                      return (a = this), (u = t), (c = r), N(I(e), a, u, c);
                    case "ucs2":
                    case "ucs-2":
                    case "utf16le":
                    case "utf-16le":
            ...
            (l.prototype.slice = function (e, t) {
              ...
              (l.prototype.copy = function (e, t, r, n) {
                ...
                var i,
                  s = n - r;
                if (this === e && r < t && t < n)
                  for (i = s - 1; 0 <= i; --i) e[i + t] = this[i + r];
              ...
              (l.prototype.fill = function (e, t, r, n) {
                ...
                if (
                  ...
                  var o = l.isBuffer(e) ? e : T(new l(e, n).toString()),
                    a = o.length;
        ...
        function (e, t, r) {
          (r.read = function (e, t, r, n, i) {
            var s,
              ...
              f = e[t + l];
            for (
              l += h, s = f & ((1 << -p) - 1), f >>= -p, p += a;
              0 < p;
              s = 256 * s + e[t + l], l += h, p -= 8
            );
            for (
              o = s & ((1 << -p) - 1), s >>= -p, p += n;
              0 < p;
              o = 256 * o + e[t + l], l += h, p -= 8
            );
            if (0 === s) s = 1 - c;
            else {
        ...
        function (e, t, r) {
          ...
          (r.byteLength = function (e) {
            ...
            (r.fromByteArray = function (e) {
              for (
                var t, r = e.length, n = r % 3, i = [], s = 0, o = r - n;
                s < o;
                s += 16383
              )
                i.push(a(e, s, o < s + 16383 ? o : s + 16383));
              return (
                1 === n
                  ? ((t = e[r - 1]),
  ...
  (AWS.KinesisAnalytics = AWS.Service.defineService("kinesisanalytics", [
    "2015-08-14",
  ])),
  ...
  (_xamzrequire = (function s(o, a, u) {
  ...
  })(
    {
      107: [
        function (e, t, r) {
          var s = e("../core"),
            o = e("../config_regional_endpoint");
          s.util.update(s.STS.prototype, {
            credentialsFrom: function (e, t) {
              return e
                ? (t || (t = new s.TemporaryCredentials()),
                  (t.expired = !1),
                  (t.accessKeyId = e.Credentials.AccessKeyId),
            ...
            optInRegionalEndpoint: function (e) {
              var t = e.service,
                r = t.config;
              if (
                ((r.stsRegionalEndpoints = o(t._originalConfig, {
                ...
                var n = r.endpoint.indexOf(".amazonaws.com"),
                  i =
                    r.endpoint.substring(0, n) +
                    "." +
                    r.region +
                    r.endpoint.substring(n);
                e.httpRequest.updateEndpoint(i),
                  (e.httpRequest.region = r.region);
              }
            },
          });
        },
