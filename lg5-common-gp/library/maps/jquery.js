...
*/
  ...
  var widgetsSlider = $.widget("ui.slider", $.ui.mouse, {
    ...
    options: {
      ...
      values: null,
      // theJ (RTL)
      isRTL: document.querySelector("html[dir=rtl") ? true : false,
      // Callbacks
      change: null,
      slide: null,
      start: null,
    ...
    _create: function () {
      ...
      this._addClass(
        "ui-slider ui-slider-" +
          this.orientation +
          (this.options.isRTL ? " ui-slider-rtl " : "") +
    ...
    _setOption: function (key, value) {
      ...
      switch (key) {
        case "isRTL": // theJ (RTL)
          this.element.toggleClass("ui-slider-rtl", s);
          this._refreshValue();
          break;
        case "orientation":
          this._detectOrientation();
      ...
      if (this._hasMultipleValues()) {
        this.handles.each(function (i) {
          valPercent =
            ...
            100;
          valPercent = o.isRTL ? 100 - valPercent : valPercent; // theJ (RTL)
            ...
            if (that.orientation === "horizontal") {
              if (i === 0) {
                that.range.stop(1, 1)[animate ? "animate" : "css"](
                  o.isRTL
                    ? { right: 100 - valPercent + "%" }
                    : { left: valPercent + "%" }, // theJ (RTL)
                  o.animate
                );
              }
              if (i === 1) {
                that.range[animate ? "animate" : "css"](
                  {
                    width:
                      (o.isRTL ? -1 : +1) * (valPercent - lastValPercent) + "%", // theJ (RTL)
                  },
                  {
                    queue: false,
                    duration: o.animate,
        ...
        if (oRange === "min" && this.orientation === "horizontal") {
          this.range.stop(1, 1)[animate ? "animate" : "css"](
            {
              width: (o.isRTL ? 100 - valPercent : valPercent) + "%", // theJ (RTL)
            },
            o.animate
          );
        }
        if (oRange === "max" && this.orientation === "horizontal") {
          this.range.stop(1, 1)[animate ? "animate" : "css"](
            {
              width: (o.isRTL ? valPercent : 100 - valPercent) + "%", // theJ (RTL)
            },
            o.animate
          );
        }
        if (oRange === "min" && this.orientation === "vertical") {
          this.range.stop(1, 1)[animate ? "animate" : "css"](
            {
              height: (o.isRTL ? 100 - valPercent : valPercent) + "%", // theJ (RTL)
            },
            o.animate
          );
        }
        if (oRange === "max" && this.orientation === "vertical") {
          this.range.stop(1, 1)[animate ? "animate" : "css"](
            {
              height: (o.isRTL ? valPercent : 100 - valPercent) + "%", // theJ (RTL)
            },
            o.animate
          );
        }
    ...
    _handleEvents: {
      keydown: function (event) {
        ...
        switch (event.keyCode) {
          ...
          case $.ui.keyCode.UP:
          case $.ui.keyCode.RIGHT:
            if (!this.options.isRTL && curVal === this._valueMax()) return; // theJ (RTL)
            if (this.options.isRTL && curVal === this._valueMin()) return;

            newVal = this._trimAlignValue(
              this.options.isRTL ? curVal - step : curVal + step
            );
            break;
          case $.ui.keyCode.DOWN:
          case $.ui.keyCode.LEFT:
            if (!this.options.isRTL && curVal === this._valueMin()) return; // theJ (RTL)
            if (this.options.isRTL && curVal === this._valueMax()) return;
